   ...
   7:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  23:	ff 35 48 0a 00 00    	pushl  0xa48
  29:	68 48 0a 00 00       	push   $0xa48
  2e:	ff 73 04             	pushl  0x4(%ebx)
  31:	68 7d 07 00 00       	push   $0x77d
  36:	6a 01                	push   $0x1
  ...
  3d:	83 c4 14             	add    $0x14,%esp
        global++;
  40:	83 05 48 0a 00 00 01 	addl   $0x1,0xa48
        sleep(1);
  47:	6a 01                	push   $0x1
  49:	e8 04 03 00 00       	call   352 <sleep>
  4e:	83 c4 10             	add    $0x10,%esp
  51:	eb cd                	jmp    20 <main+0x20>
        printf(1, "usage: mem <string>\n");
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 8a 07 00 00       	mov    $0x78a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 4c 0a 00 00       	mov    0xa4c,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 737:	0a 00 00 
 73a:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 50 0a 00 00       	mov    $0xa50,%eax
 749:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 750:	00 00 00 
