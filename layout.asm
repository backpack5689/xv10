...
_layout:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  12:	83 ec 18             	sub    $0x18,%esp
    char *p = malloc(1);
  15:	6a 01                	push   $0x1
  17:	e8 64 06 00 00       	call   680 <malloc>
    printf(1, "main=%p\n",&main);
  ...
  26:	68 78 07 00 00       	push   $0x778
  2b:	6a 01                	push   $0x1
  2d:	e8 ee 03 00 00       	call   420 <printf>
    printf(1, "global=%p\n",&global);
  32:	83 c4 0c             	add    $0xc,%esp
  35:	68 68 0a 00 00       	push   $0xa68
  3a:	68 81 07 00 00       	push   $0x781
  3f:	6a 01                	push   $0x1
  41:	e8 da 03 00 00       	call   420 <printf>
    printf(1, "_end=%p\n",&_end);
  46:	83 c4 0c             	add    $0xc,%esp
  49:	68 6c 0a 00 00       	push   $0xa6c
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb a8 07 00 00       	mov    $0x7a8,%ebx
        while(*s != 0){
