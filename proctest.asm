...
_proctest:     file format elf32-i386
...
int main(int argc, char ** const argv)
{
  ...
  11:	6a 23                	push   $0x23
  13:	6a 00                	push   $0x0
  15:	e8 18 03 00 00       	call   332 <setpriority>
    setpriority(1, 50);
  1a:	58                   	pop    %eax
  1b:	5a                   	pop    %edx
  1c:	6a 32                	push   $0x32
  1e:	6a 01                	push   $0x1
  20:	e8 0d 03 00 00       	call   332 <setpriority>
    sleep(5000000);
  25:	c7 04 24 40 4b 4c 00 	movl   $0x4c4b40,(%esp)
  2c:	e8 f1 02 00 00       	call   322 <sleep>
