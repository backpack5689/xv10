...
801002a1:	8b 15 a0 09 11 80    	mov    0x801109a0,%edx
801002a7:	39 15 a4 09 11 80    	cmp    %edx,0x801109a4
...
801002c0:	68 a0 09 11 80       	push   $0x801109a0
801002c5:	e8 a6 3d 00 00       	call   80104070 <sleep>
    while(input.r == input.w){
801002ca:	8b 15 a0 09 11 80    	mov    0x801109a0,%edx
801002d0:	83 c4 10             	add    $0x10,%esp
801002d3:	3b 15 a4 09 11 80    	cmp    0x801109a4,%edx
...
80100313:	a3 a0 09 11 80       	mov    %eax,0x801109a0
80100318:	89 d0                	mov    %edx,%eax
8010031a:	83 e0 7f             	and    $0x7f,%eax
8010031d:	0f be 80 20 09 11 80 	movsbl -0x7feef6e0(%eax),%eax
    if(c == C('D')){  // EOF
...
80100370:	73 d0                	jae    80100342 <consoleread+0xd2>
        input.r--;
80100372:	89 15 a0 09 11 80    	mov    %edx,0x801109a0
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 9b 7b 10 80 	movl   $0x80107b9b,(%esp)
...
8010084f:	75 54                	jne    801008a5 <consoleintr+0x95>
      if(input.e != input.w){
80100851:	a1 a8 09 11 80       	mov    0x801109a8,%eax
80100856:	3b 05 a4 09 11 80    	cmp    0x801109a4,%eax
8010085c:	74 d2                	je     80100830 <consoleintr+0x20>
        input.e--;
8010085e:	83 e8 01             	sub    $0x1,%eax
80100861:	a3 a8 09 11 80       	mov    %eax,0x801109a8
        consputc(BACKSPACE);
...
801008a9:	a1 a8 09 11 80       	mov    0x801109a8,%eax
801008ae:	89 c2                	mov    %eax,%edx
801008b0:	2b 15 a0 09 11 80    	sub    0x801109a0,%edx
...
801008c8:	89 15 a8 09 11 80    	mov    %edx,0x801109a8
        c = (c == '\r') ? '\n' : c;
801008ce:	0f 84 cc 00 00 00    	je     801009a0 <consoleintr+0x190>
        input.buf[input.e++ % INPUT_BUF] = c;
801008d4:	89 f9                	mov    %edi,%ecx
801008d6:	88 88 20 09 11 80    	mov    %cl,-0x7feef6e0(%eax)
        consputc(c);
...
801008f5:	a1 a0 09 11 80       	mov    0x801109a0,%eax
801008fa:	83 e8 80             	sub    $0xffffff80,%eax
801008fd:	39 05 a8 09 11 80    	cmp    %eax,0x801109a8
80100903:	0f 85 27 ff ff ff    	jne    80100830 <consoleintr+0x20>
          wakeup(&input.r);
80100909:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
8010090c:	a3 a4 09 11 80       	mov    %eax,0x801109a4
          wakeup(&input.r);
80100911:	68 a0 09 11 80       	push   $0x801109a0
...
80100938:	a1 a8 09 11 80       	mov    0x801109a8,%eax
8010093d:	39 05 a4 09 11 80    	cmp    %eax,0x801109a4
80100943:	75 2b                	jne    80100970 <consoleintr+0x160>
80100945:	e9 e6 fe ff ff       	jmp    80100830 <consoleintr+0x20>
8010094a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        input.e--;
80100950:	a3 a8 09 11 80       	mov    %eax,0x801109a8
        consputc(BACKSPACE);
80100955:	b8 00 01 00 00       	mov    $0x100,%eax
8010095a:	e8 b1 fa ff ff       	call   80100410 <consputc>
      while(input.e != input.w &&
8010095f:	a1 a8 09 11 80       	mov    0x801109a8,%eax
80100964:	3b 05 a4 09 11 80    	cmp    0x801109a4,%eax
...
80100975:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100978:	80 ba 20 09 11 80 0a 	cmpb   $0xa,-0x7feef6e0(%edx)
...
8010099c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        input.buf[input.e++ % INPUT_BUF] = c;
801009a0:	c6 80 20 09 11 80 0a 	movb   $0xa,-0x7feef6e0(%eax)
        consputc(c);
801009a7:	b8 0a 00 00 00       	mov    $0xa,%eax
801009ac:	e8 5f fa ff ff       	call   80100410 <consputc>
801009b1:	a1 a8 09 11 80       	mov    0x801109a8,%eax
...
801009d9:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
801009db:	c7 05 6c 13 11 80 00 	movl   $0x80100600,0x8011136c
801009e2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009e5:	c7 05 68 13 11 80 70 	movl   $0x80100270,0x80111368
801009ec:	02 10 80 
  cons.locking = 1;
...
80100d35:	e8 16 5e 00 00       	call   80106b50 <switchuvm>
  freevm(oldpgdir);
80100d3a:	89 3c 24             	mov    %edi,(%esp)
80100d3d:	e8 be 61 00 00       	call   80106f00 <freevm>
  return 0;
...
80100d6b:	68 c0 09 11 80       	push   $0x801109c0
...
80100d84:	bb f4 09 11 80       	mov    $0x801109f4,%ebx
{
80100d89:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100d8c:	68 c0 09 11 80       	push   $0x801109c0
...
80100da3:	81 fb 54 13 11 80    	cmp    $0x80111354,%ebx
...
80100db5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dbc:	68 c0 09 11 80       	push   $0x801109c0
...
80100dd3:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100dd5:	68 c0 09 11 80       	push   $0x801109c0
...
80100df7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dfa:	68 c0 09 11 80       	push   $0x801109c0
...
80100e14:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e17:	68 c0 09 11 80       	push   $0x801109c0
...
80100e49:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100e4c:	68 c0 09 11 80       	push   $0x801109c0
...
80100e6c:	74 1a                	je     80100e88 <fileclose+0x48>
    release(&ftable.lock);
80100e6e:	c7 45 08 c0 09 11 80 	movl   $0x801109c0,0x8(%ebp)
...
80100e9d:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100ea0:	68 c0 09 11 80       	push   $0x801109c0
  ff = *f;
...
8010111a:	03 15 d8 13 11 80    	add    0x801113d8,%edx
...
80101189:	8b 0d c0 13 11 80    	mov    0x801113c0,%ecx
{
...
801011ac:	03 05 d8 13 11 80    	add    0x801113d8,%eax
801011b2:	50                   	push   %eax
801011b3:	ff 75 d8             	pushl  -0x28(%ebp)
801011b6:	e8 15 ef ff ff       	call   801000d0 <bread>
801011bb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
801011be:	a1 c0 13 11 80       	mov    0x801113c0,%eax
...
80101219:	39 05 c0 13 11 80    	cmp    %eax,0x801113c0
...
8010129a:	bb 14 14 11 80       	mov    $0x80111414,%ebx
{
8010129f:	83 ec 28             	sub    $0x28,%esp
801012a2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012a5:	68 e0 13 11 80       	push   $0x801113e0
...
801012c6:	81 fb 34 30 11 80    	cmp    $0x80113034,%ebx
...
801012e8:	81 fb 34 30 11 80    	cmp    $0x80113034,%ebx
...
80101303:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010130a:	68 e0 13 11 80       	push   $0x801113e0
...
80101333:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
80101335:	68 e0 13 11 80       	push   $0x801113e0
      ip->ref++;
...
80101484:	bb 20 14 11 80       	mov    $0x80111420,%ebx
80101489:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010148c:	68 2b 73 10 80       	push   $0x8010732b
80101491:	68 e0 13 11 80       	push   $0x801113e0
...
801014b7:	81 fb 40 30 11 80    	cmp    $0x80113040,%ebx
801014bd:	75 e1                	jne    801014a0 <iinit+0x20>
  readsb(dev, &sb);
801014bf:	83 ec 08             	sub    $0x8,%esp
801014c2:	68 c0 13 11 80       	push   $0x801113c0
801014c7:	ff 75 08             	pushl  0x8(%ebp)
801014ca:	e8 71 ff ff ff       	call   80101440 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014cf:	ff 35 d8 13 11 80    	pushl  0x801113d8
801014d5:	ff 35 d4 13 11 80    	pushl  0x801113d4
801014db:	ff 35 d0 13 11 80    	pushl  0x801113d0
801014e1:	ff 35 cc 13 11 80    	pushl  0x801113cc
801014e7:	ff 35 c8 13 11 80    	pushl  0x801113c8
801014ed:	ff 35 c4 13 11 80    	pushl  0x801113c4
801014f3:	ff 35 c0 13 11 80    	pushl  0x801113c0
...
80101519:	83 3d c8 13 11 80 01 	cmpl   $0x1,0x801113c8
{
...
8010154f:	39 1d c8 13 11 80    	cmp    %ebx,0x801113c8
80101555:	76 69                	jbe    801015c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101557:	89 d8                	mov    %ebx,%eax
80101559:	83 ec 08             	sub    $0x8,%esp
8010155c:	c1 e8 03             	shr    $0x3,%eax
8010155f:	03 05 d4 13 11 80    	add    0x801113d4,%eax
...
801015e4:	03 05 d4 13 11 80    	add    0x801113d4,%eax
...
80101657:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010165a:	68 e0 13 11 80       	push   $0x801113e0
8010165f:	e8 fc 2f 00 00       	call   80104660 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 e0 13 11 80 	movl   $0x801113e0,(%esp)
...
801016c9:	03 05 d4 13 11 80    	add    0x801113d4,%eax
...
801017da:	e8 b1 2c 00 00       	call   80104490 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 e0 13 11 80 	movl   $0x801113e0,(%esp)
801017e6:	e8 75 2e 00 00       	call   80104660 <acquire>
  ip->ref--;
801017eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801017ef:	83 c4 10             	add    $0x10,%esp
801017f2:	c7 45 08 e0 13 11 80 	movl   $0x801113e0,0x8(%ebp)
}
...
8010180b:	68 e0 13 11 80       	push   $0x801113e0
80101810:	e8 4b 2e 00 00       	call   80104660 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 e0 13 11 80 	movl   $0x801113e0,(%esp)
...
80101a3a:	8b 04 c5 60 13 11 80 	mov    -0x7feeeca0(,%eax,8),%eax
...
80101b4a:	8b 04 c5 64 13 11 80 	mov    -0x7feeec9c(,%eax,8),%eax
...
80101c73:	0f 84 67 01 00 00    	je     80101de0 <namex+0x180>
    ...
    ip = idup(myproc()->cwd);
80101c79:	e8 32 1d 00 00       	call   801039b0 <myproc>
  acquire(&icache.lock);
80101c7e:	83 ec 0c             	sub    $0xc,%esp
    ip = idup(myproc()->cwd);
80101c81:	8b 70 6c             	mov    0x6c(%eax),%esi
  acquire(&icache.lock);
80101c84:	68 e0 13 11 80       	push   $0x801113e0
80101c89:	e8 d2 29 00 00       	call   80104660 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 e0 13 11 80 	movl   $0x801113e0,(%esp)
...
80101ec8:	68 82 79 10 80       	push   $0x80107982
...
80102015:	58                   	pop    %eax
80102016:	a1 00 37 11 80       	mov    0x80113700,%eax
8010201b:	5a                   	pop    %edx
...
801020f1:	e8 3a 21 00 00       	call   80104230 <wakeup>
...
801021b9:	e8 b2 1e 00 00       	call   80104070 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102221:	c7 05 34 30 11 80 00 	movl   $0xfec00000,0x80113034
80102228:	00 c0 fe 
{
...
80102236:	00 00 00 
  return ioapic->data;
80102239:	a1 34 30 11 80       	mov    0x80113034,%eax
8010223e:	8b 58 10             	mov    0x10(%eax),%ebx
  ioapic->reg = reg;
80102241:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return ioapic->data;
80102247:	8b 0d 34 30 11 80    	mov    0x80113034,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
8010224d:	0f b6 15 60 31 11 80 	movzbl 0x80113160,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
80102271:	8b 0d 34 30 11 80    	mov    0x80113034,%ecx
...
80102290:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102292:	8b 0d 34 30 11 80    	mov    0x80113034,%ecx
...
801022ae:	89 31                	mov    %esi,(%ecx)
  ioapic->data = data;
801022b0:	8b 0d 34 30 11 80    	mov    0x80113034,%ecx
...
801022d0:	55                   	push   %ebp
  ioapic->reg = reg;
801022d1:	8b 0d 34 30 11 80    	mov    0x80113034,%ecx
{
...
801022e3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022e5:	8b 0d 34 30 11 80    	mov    0x80113034,%ecx
...
801022f4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022f6:	a1 34 30 11 80       	mov    0x80113034,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102322:	81 fb a8 60 11 80    	cmp    $0x801160a8,%ebx
...
80102342:	e8 29 24 00 00       	call   80104770 <memset>
  ...
  if(kmem.use_lock)
80102347:	8b 15 74 30 11 80    	mov    0x80113074,%edx
...
80102354:	a1 78 30 11 80       	mov    0x80113078,%eax
80102359:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010235b:	a1 74 30 11 80       	mov    0x80113074,%eax
  kmem.freelist = r;
80102360:	89 1d 78 30 11 80    	mov    %ebx,0x80113078
  if(kmem.use_lock)
...
8010236f:	90                   	nop
    release(&kmem.lock);
80102370:	c7 45 08 40 30 11 80 	movl   $0x80113040,0x8(%ebp)
}
...
80102383:	68 40 30 11 80       	push   $0x80113040
...
80102400:	68 40 30 11 80       	push   $0x80113040
...
8010240d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102410:	c7 05 74 30 11 80 00 	movl   $0x0,0x80113074
80102417:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
801024a2:	73 e4                	jae    80102488 <kinit2+0x28>
  kmem.use_lock = 1;
801024a4:	c7 05 74 30 11 80 01 	movl   $0x1,0x80113074
801024ab:	00 00 00 
}
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
801024c0:	a1 74 30 11 80       	mov    0x80113074,%eax
801024c5:	85 c0                	test   %eax,%eax
801024c7:	75 1f                	jne    801024e8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
801024c9:	a1 78 30 11 80       	mov    0x80113078,%eax
  if(r)
801024ce:	85 c0                	test   %eax,%eax
801024d0:	74 0e                	je     801024e0 <kalloc+0x20>
    kmem.freelist = r->next;
801024d2:	8b 10                	mov    (%eax),%edx
801024d4:	89 15 78 30 11 80    	mov    %edx,0x80113078
801024da:	c3                   	ret    
801024db:	90                   	nop
...
801024eb:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801024ee:	68 40 30 11 80       	push   $0x80113040
801024f3:	e8 68 21 00 00       	call   80104660 <acquire>
  r = kmem.freelist;
801024f8:	a1 78 30 11 80       	mov    0x80113078,%eax
  if(r)
801024fd:	83 c4 10             	add    $0x10,%esp
80102500:	8b 15 74 30 11 80    	mov    0x80113074,%edx
80102506:	85 c0                	test   %eax,%eax
80102508:	74 08                	je     80102512 <kalloc+0x52>
    kmem.freelist = r->next;
8010250a:	8b 08                	mov    (%eax),%ecx
8010250c:	89 0d 78 30 11 80    	mov    %ecx,0x80113078
  if(kmem.use_lock)
...
8010251c:	68 40 30 11 80       	push   $0x80113040
...
{
  if(!lapic)
80102630:	a1 7c 30 11 80       	mov    0x8011307c,%eax
{
...
{
  if (!lapic)
80102730:	8b 15 7c 30 11 80    	mov    0x8011307c,%edx
{
...
{
  if(lapic)
80102750:	a1 7c 30 11 80       	mov    0x8011307c,%eax
{
...
801027b8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801027be:	a1 7c 30 11 80       	mov    0x8011307c,%eax
...
80102a00:	8b 0d c8 30 11 80    	mov    0x801130c8,%ecx
...
80102a20:	a1 b4 30 11 80       	mov    0x801130b4,%eax
80102a25:	83 ec 08             	sub    $0x8,%esp
80102a28:	01 d8                	add    %ebx,%eax
80102a2a:	83 c0 01             	add    $0x1,%eax
80102a2d:	50                   	push   %eax
80102a2e:	ff 35 c4 30 11 80    	pushl  0x801130c4
80102a34:	e8 97 d6 ff ff       	call   801000d0 <bread>
80102a39:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a3b:	58                   	pop    %eax
80102a3c:	5a                   	pop    %edx
80102a3d:	ff 34 9d cc 30 11 80 	pushl  -0x7feecf34(,%ebx,4)
80102a44:	ff 35 c4 30 11 80    	pushl  0x801130c4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102a84:	39 1d c8 30 11 80    	cmp    %ebx,0x801130c8
...
80102aa8:	ff 35 b4 30 11 80    	pushl  0x801130b4
80102aae:	ff 35 c4 30 11 80    	pushl  0x801130c4
80102ab4:	e8 17 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102ab9:	8b 1d c8 30 11 80    	mov    0x801130c8,%ebx
...
80102ad0:	8b 8a cc 30 11 80    	mov    -0x7feecf34(%edx),%ecx
...
80102b0f:	68 80 30 11 80       	push   $0x80113080
...
80102b2b:	59                   	pop    %ecx
  log.dev = dev;
80102b2c:	89 1d c4 30 11 80    	mov    %ebx,0x801130c4
  log.size = sb.nlog;
80102b32:	89 15 b8 30 11 80    	mov    %edx,0x801130b8
  log.start = sb.logstart;
80102b38:	a3 b4 30 11 80       	mov    %eax,0x801130b4
  struct buf *buf = bread(log.dev, log.start);
80102b3d:	5a                   	pop    %edx
...
80102b4b:	85 db                	test   %ebx,%ebx
  log.lh.n = lh->n;
80102b4d:	89 1d c8 30 11 80    	mov    %ebx,0x801130c8
  for (i = 0; i < log.lh.n; i++) {
...
80102b67:	89 8a c8 30 11 80    	mov    %ecx,-0x7feecf38(%edx)
  for (i = 0; i < log.lh.n; i++) {
...
80102b7a:	e8 81 fe ff ff       	call   80102a00 <install_trans>
  log.lh.n = 0;
80102b7f:	c7 05 c8 30 11 80 00 	movl   $0x0,0x801130c8
80102b86:	00 00 00 
...
80102ba3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102ba6:	68 80 30 11 80       	push   $0x80113080
...
80102bbb:	68 80 30 11 80       	push   $0x80113080
80102bc0:	68 80 30 11 80       	push   $0x80113080
80102bc5:	e8 a6 14 00 00       	call   80104070 <sleep>
80102bca:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102bcd:	a1 c0 30 11 80       	mov    0x801130c0,%eax
80102bd2:	85 c0                	test   %eax,%eax
80102bd4:	75 e2                	jne    80102bb8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102bd6:	a1 bc 30 11 80       	mov    0x801130bc,%eax
80102bdb:	8b 15 c8 30 11 80    	mov    0x801130c8,%edx
...
80102bef:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102bf2:	a3 bc 30 11 80       	mov    %eax,0x801130bc
      release(&log.lock);
80102bf7:	68 80 30 11 80       	push   $0x80113080
...
80102c16:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c19:	68 80 30 11 80       	push   $0x80113080
80102c1e:	e8 3d 1a 00 00       	call   80104660 <acquire>
  log.outstanding -= 1;
80102c23:	a1 bc 30 11 80       	mov    0x801130bc,%eax
  if(log.committing)
80102c28:	8b 35 c0 30 11 80    	mov    0x801130c0,%esi
...
80102c34:	85 f6                	test   %esi,%esi
  log.outstanding -= 1;
80102c36:	89 1d bc 30 11 80    	mov    %ebx,0x801130bc
  if(log.committing)
...
80102c4a:	83 ec 0c             	sub    $0xc,%esp
    log.committing = 1;
80102c4d:	c7 05 c0 30 11 80 01 	movl   $0x1,0x801130c0
80102c54:	00 00 00 
  release(&log.lock);
80102c57:	68 80 30 11 80       	push   $0x80113080
...
{
  if (log.lh.n > 0) {
80102c61:	8b 0d c8 30 11 80    	mov    0x801130c8,%ecx
80102c67:	83 c4 10             	add    $0x10,%esp
80102c6a:	85 c9                	test   %ecx,%ecx
80102c6c:	0f 8e 85 00 00 00    	jle    80102cf7 <end_op+0xe7>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80102c72:	a1 b4 30 11 80       	mov    0x801130b4,%eax
80102c77:	83 ec 08             	sub    $0x8,%esp
80102c7a:	01 d8                	add    %ebx,%eax
80102c7c:	83 c0 01             	add    $0x1,%eax
80102c7f:	50                   	push   %eax
80102c80:	ff 35 c4 30 11 80    	pushl  0x801130c4
80102c86:	e8 45 d4 ff ff       	call   801000d0 <bread>
80102c8b:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c8d:	58                   	pop    %eax
80102c8e:	5a                   	pop    %edx
80102c8f:	ff 34 9d cc 30 11 80 	pushl  -0x7feecf34(,%ebx,4)
80102c96:	ff 35 c4 30 11 80    	pushl  0x801130c4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102cd6:	3b 1d c8 30 11 80    	cmp    0x801130c8,%ebx
...
80102ce3:	e8 18 fd ff ff       	call   80102a00 <install_trans>
    log.lh.n = 0;
80102ce8:	c7 05 c8 30 11 80 00 	movl   $0x0,0x801130c8
80102cef:	00 00 00 
    write_head();    // Erase the transaction from the log
80102cf2:	e8 a9 fd ff ff       	call   80102aa0 <write_head>
    acquire(&log.lock);
80102cf7:	83 ec 0c             	sub    $0xc,%esp
80102cfa:	68 80 30 11 80       	push   $0x80113080
80102cff:	e8 5c 19 00 00       	call   80104660 <acquire>
    wakeup(&log);
80102d04:	c7 04 24 80 30 11 80 	movl   $0x80113080,(%esp)
    log.committing = 0;
80102d0b:	c7 05 c0 30 11 80 00 	movl   $0x0,0x801130c0
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 16 15 00 00       	call   80104230 <wakeup>
    release(&log.lock);
80102d1a:	c7 04 24 80 30 11 80 	movl   $0x80113080,(%esp)
...
80102d3b:	68 80 30 11 80       	push   $0x80113080
80102d40:	e8 eb 14 00 00       	call   80104230 <wakeup>
  release(&log.lock);
80102d45:	c7 04 24 80 30 11 80 	movl   $0x80113080,(%esp)
...
80102d77:	8b 15 c8 30 11 80    	mov    0x801130c8,%edx
{
80102d7d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102d80:	83 fa 1d             	cmp    $0x1d,%edx
80102d83:	0f 8f 9d 00 00 00    	jg     80102e26 <log_write+0xb6>
80102d89:	a1 b8 30 11 80       	mov    0x801130b8,%eax
80102d8e:	83 e8 01             	sub    $0x1,%eax
80102d91:	39 c2                	cmp    %eax,%edx
80102d93:	0f 8d 8d 00 00 00    	jge    80102e26 <log_write+0xb6>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102d99:	a1 bc 30 11 80       	mov    0x801130bc,%eax
...
80102da9:	68 80 30 11 80       	push   $0x80113080
80102dae:	e8 ad 18 00 00       	call   80104660 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102db3:	8b 0d c8 30 11 80    	mov    0x801130c8,%ecx
...
80102dc4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102dc6:	3b 15 cc 30 11 80    	cmp    0x801130cc,%edx
80102dcc:	75 0b                	jne    80102dd9 <log_write+0x69>
80102dce:	eb 38                	jmp    80102e08 <log_write+0x98>
80102dd0:	39 14 85 cc 30 11 80 	cmp    %edx,-0x7feecf34(,%eax,4)
...
80102de0:	89 14 85 cc 30 11 80 	mov    %edx,-0x7feecf34(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
80102de7:	83 c0 01             	add    $0x1,%eax
80102dea:	a3 c8 30 11 80       	mov    %eax,0x801130c8
  b->flags |= B_DIRTY; // prevent eviction
80102def:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102df2:	c7 45 08 80 30 11 80 	movl   $0x80113080,0x8(%ebp)
}
...
80102e02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102e08:	89 14 85 cc 30 11 80 	mov    %edx,-0x7feecf34(,%eax,4)
80102e0f:	eb de                	jmp    80102def <log_write+0x7f>
80102e11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80102e18:	8b 43 08             	mov    0x8(%ebx),%eax
80102e1b:	a3 cc 30 11 80       	mov    %eax,0x801130cc
  if (i == log.lh.n)
...
80102e47:	e8 44 0b 00 00       	call   80103990 <cpuid>
80102e4c:	89 c3                	mov    %eax,%ebx
80102e4e:	e8 3d 0b 00 00       	call   80103990 <cpuid>
...
80102e62:	e8 d9 2b 00 00       	call   80105a40 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102e67:	e8 a4 0a 00 00       	call   80103910 <mycpu>
...
80102eb7:	68 a8 60 11 80       	push   $0x801160a8
...
80102ee4:	e8 87 2e 00 00       	call   80105d70 <uartinit>
  pinit();         // process table
80102ee9:	e8 02 0a 00 00       	call   801038f0 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 cd 2a 00 00       	call   801059c0 <tvinit>
  binit();         // buffer cache
...
80102f19:	69 05 00 37 11 80 b0 	imul   $0xb0,0x80113700,%eax
80102f20:	00 00 00 
80102f23:	83 c4 10             	add    $0x10,%esp
80102f26:	05 80 31 11 80       	add    $0x80113180,%eax
80102f2b:	3d 80 31 11 80       	cmp    $0x80113180,%eax
80102f30:	76 71                	jbe    80102fa3 <main+0x103>
80102f32:	bb 80 31 11 80       	mov    $0x80113180,%ebx
80102f37:	89 f6                	mov    %esi,%esi
80102f39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(c == mycpu())  // We've started already.
80102f40:	e8 cb 09 00 00       	call   80103910 <mycpu>
...
80102f88:	74 f6                	je     80102f80 <main+0xe0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f8a:	69 05 00 37 11 80 b0 	imul   $0xb0,0x80113700,%eax
80102f91:	00 00 00 
80102f94:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102f9a:	05 80 31 11 80       	add    $0x80113180,%eax
...
80102fb5:	e8 d6 0a 00 00       	call   80103a90 <userinit>
...
80103117:	a3 7c 30 11 80       	mov    %eax,0x8011307c
...
80103185:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103188:	8b 0d 00 37 11 80    	mov    0x80113700,%ecx
...
801031a0:	89 0d 00 37 11 80    	mov    %ecx,0x80113700
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031a6:	88 97 80 31 11 80    	mov    %dl,-0x7feece80(%edi)
...
801031bc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031bf:	88 15 60 31 11 80    	mov    %dl,0x80113160
      continue;
...
8010337f:	e8 ac 0e 00 00       	call   80104230 <wakeup>
...
801033c4:	e8 67 0e 00 00       	call   80104230 <wakeup>
...
80103454:	e8 d7 0d 00 00       	call   80104230 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103459:	5a                   	pop    %edx
8010345a:	59                   	pop    %ecx
8010345b:	53                   	push   %ebx
8010345c:	56                   	push   %esi
8010345d:	e8 0e 0c 00 00       	call   80104070 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103484:	e8 27 05 00 00       	call   801039b0 <myproc>
...
801034e3:	e8 48 0d 00 00       	call   80104230 <wakeup>
  release(&p->lock);
...
80103545:	e8 26 0b 00 00       	call   80104070 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103563:	0f 84 8f 00 00 00    	je     801035f8 <piperead+0xf8>
    if(myproc()->killed){
80103569:	e8 42 04 00 00       	call   801039b0 <myproc>
...
801035d7:	e8 54 0c 00 00       	call   80104230 <wakeup>
  release(&p->lock);
...
80103604:	bb 54 37 11 80       	mov    $0x80113754,%ebx
{
80103609:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010360c:	68 20 37 11 80       	push   $0x80113720
...
80103626:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
...
80103647:	89 43 14             	mov    %eax,0x14(%ebx)
  release(&ptable.lock);
8010364a:	68 20 37 11 80       	push   $0x80113720
  p->pid = nextpid++;
8010364f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103655:	e8 c6 10 00 00       	call   80104720 <release>
...
80103677:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
8010367a:	c7 40 14 af 59 10 80 	movl   $0x801059af,0x14(%eax)
  p->context = (struct context*)sp;
...
80103689:	e8 e2 10 00 00       	call   80104770 <memset>
...
801036ab:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036ad:	68 20 37 11 80       	push   $0x80113720
801036b2:	e8 69 10 00 00       	call   80104720 <release>
}
...
801036d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036d6:	68 20 37 11 80       	push   $0x80113720
801036db:	e8 40 10 00 00       	call   80104720 <release>
...
80103721:	b8 e4 a5 10 80       	mov    $0x8010a5e4,%eax
80103726:	b9 9c af 10 80       	mov    $0x8010af9c,%ecx
8010372b:	89 e5                	mov    %esp,%ebp
8010372d:	8b 55 08             	mov    0x8(%ebp),%edx
    /* setting initial seeds to mt[N] using         */
    /* the generator Line 25 of Table 1 in          */
    /* [KNUTH 1981, The Art of Computer Programming */
    /*    Vol. 2 (2nd Ed.), pp102]                  */
    mt[0]= seed & 0xffffffff;
80103730:	89 15 e0 a5 10 80    	mov    %edx,0x8010a5e0
80103736:	eb 0b                	jmp    80103743 <sgenrand+0x23>
80103738:	90                   	nop
80103739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103740:	83 c0 04             	add    $0x4,%eax
    for (mti=1; mti<N; mti++)
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
80103743:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
80103749:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010374b:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
8010374d:	75 f1                	jne    80103740 <sgenrand+0x20>
8010374f:	c7 05 08 a0 10 80 70 	movl   $0x270,0x8010a008
80103756:	02 00 00 
}
80103759:	5d                   	pop    %ebp
8010375a:	c3                   	ret    
...
80103760:	a1 08 a0 10 80       	mov    0x8010a008,%eax
{
...
80103769:	53                   	push   %ebx
    if (mti >= N) { /* generate N words at one time */
8010376a:	3d 6f 02 00 00       	cmp    $0x26f,%eax
8010376f:	0f 8e f9 00 00 00    	jle    8010386e <genrand+0x10e>
        int kk;

        if (mti == N+1)   /* if sgenrand() has not been called, */
80103775:	3d 71 02 00 00       	cmp    $0x271,%eax
8010377a:	0f 84 fa 00 00 00    	je     8010387a <genrand+0x11a>
80103780:	ba e0 a5 10 80       	mov    $0x8010a5e0,%edx
80103785:	bb 6c a9 10 80       	mov    $0x8010a96c,%ebx
    mt[0]= seed & 0xffffffff;
8010378a:	89 d1                	mov    %edx,%ecx
8010378c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            sgenrand(4357); /* a default initial seed is used   */

        for (kk=0;kk<N-M;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80103790:	8b 01                	mov    (%ecx),%eax
80103792:	8b 71 04             	mov    0x4(%ecx),%esi
80103795:	83 c1 04             	add    $0x4,%ecx
80103798:	81 e6 ff ff ff 7f    	and    $0x7fffffff,%esi
8010379e:	25 00 00 00 80       	and    $0x80000000,%eax
801037a3:	09 f0                	or     %esi,%eax
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
801037a5:	89 c6                	mov    %eax,%esi
801037a7:	83 e0 01             	and    $0x1,%eax
801037aa:	d1 ee                	shr    %esi
801037ac:	33 b1 30 06 00 00    	xor    0x630(%ecx),%esi
801037b2:	33 34 85 a0 78 10 80 	xor    -0x7fef8760(,%eax,4),%esi
801037b9:	89 71 fc             	mov    %esi,-0x4(%ecx)
        for (kk=0;kk<N-M;kk++) {
801037bc:	39 cb                	cmp    %ecx,%ebx
801037be:	75 d0                	jne    80103790 <genrand+0x30>
801037c0:	b9 10 ac 10 80       	mov    $0x8010ac10,%ecx
801037c5:	8d 76 00             	lea    0x0(%esi),%esi
        }
        for (;kk<N-1;kk++) {
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
801037c8:	8b 82 8c 03 00 00    	mov    0x38c(%edx),%eax
801037ce:	8b 9a 90 03 00 00    	mov    0x390(%edx),%ebx
801037d4:	83 c2 04             	add    $0x4,%edx
801037d7:	81 e3 ff ff ff 7f    	and    $0x7fffffff,%ebx
801037dd:	25 00 00 00 80       	and    $0x80000000,%eax
801037e2:	09 d8                	or     %ebx,%eax
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
801037e4:	89 c3                	mov    %eax,%ebx
801037e6:	83 e0 01             	and    $0x1,%eax
801037e9:	d1 eb                	shr    %ebx
801037eb:	33 5a fc             	xor    -0x4(%edx),%ebx
801037ee:	33 1c 85 a0 78 10 80 	xor    -0x7fef8760(,%eax,4),%ebx
801037f5:	89 9a 88 03 00 00    	mov    %ebx,0x388(%edx)
        for (;kk<N-1;kk++) {
801037fb:	39 d1                	cmp    %edx,%ecx
801037fd:	75 c9                	jne    801037c8 <genrand+0x68>
        }
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
801037ff:	a1 e0 a5 10 80       	mov    0x8010a5e0,%eax
80103804:	8b 0d 9c af 10 80    	mov    0x8010af9c,%ecx
8010380a:	89 c2                	mov    %eax,%edx
8010380c:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
80103812:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80103818:	09 d1                	or     %edx,%ecx
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
8010381a:	89 ca                	mov    %ecx,%edx
8010381c:	83 e1 01             	and    $0x1,%ecx
8010381f:	d1 ea                	shr    %edx
80103821:	33 15 10 ac 10 80    	xor    0x8010ac10,%edx
80103827:	33 14 8d a0 78 10 80 	xor    -0x7fef8760(,%ecx,4),%edx
8010382e:	89 15 9c af 10 80    	mov    %edx,0x8010af9c
80103834:	ba 01 00 00 00       	mov    $0x1,%edx

        mti = 0;
    }
  
    y = mt[mti++];
80103839:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
    y ^= TEMPERING_SHIFT_U(y);
8010383f:	89 c2                	mov    %eax,%edx
80103841:	c1 ea 0b             	shr    $0xb,%edx
80103844:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
80103846:	89 d0                	mov    %edx,%eax
80103848:	c1 e0 07             	shl    $0x7,%eax
8010384b:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
80103850:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
80103852:	89 d0                	mov    %edx,%eax
80103854:	c1 e0 0f             	shl    $0xf,%eax
80103857:	25 00 00 c6 ef       	and    $0xefc60000,%eax
8010385c:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_L(y);
8010385e:	89 c2                	mov    %eax,%edx
80103860:	c1 ea 12             	shr    $0x12,%edx
80103863:	31 d0                	xor    %edx,%eax
...
80103865:	5b                   	pop    %ebx
    return y & RAND_MAX;
80103866:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
8010386b:	5e                   	pop    %esi
8010386c:	5d                   	pop    %ebp
8010386d:	c3                   	ret    
8010386e:	8d 50 01             	lea    0x1(%eax),%edx
80103871:	8b 04 85 e0 a5 10 80 	mov    -0x7fef5a20(,%eax,4),%eax
80103878:	eb bf                	jmp    80103839 <genrand+0xd9>
    mt[0]= seed & 0xffffffff;
8010387a:	c7 05 e0 a5 10 80 05 	movl   $0x1105,0x8010a5e0
80103881:	11 00 00 
80103884:	b8 e4 a5 10 80       	mov    $0x8010a5e4,%eax
80103889:	b9 9c af 10 80       	mov    $0x8010af9c,%ecx
8010388e:	ba 05 11 00 00       	mov    $0x1105,%edx
80103893:	eb 06                	jmp    8010389b <genrand+0x13b>
80103895:	8d 76 00             	lea    0x0(%esi),%esi
80103898:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010389b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
    for (mti=1; mti<N; mti++)
801038a1:	39 c1                	cmp    %eax,%ecx
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801038a3:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801038a5:	75 f1                	jne    80103898 <genrand+0x138>
801038a7:	e9 d4 fe ff ff       	jmp    80103780 <genrand+0x20>
801038ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801038b0 <random_at_most>:
...
801038b7:	8b 45 08             	mov    0x8(%ebp),%eax
    bin_size = num_rand / num_bins,
801038ba:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
801038bf:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
801038c2:	89 d8                	mov    %ebx,%eax
801038c4:	f7 f1                	div    %ecx
801038c6:	89 c6                	mov    %eax,%esi
801038c8:	29 d3                	sub    %edx,%ebx
801038ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  do {
   x = genrand();
801038d0:	e8 8b fe ff ff       	call   80103760 <genrand>
  }
  // This is carefully written not to overflow
  while (num_rand - defect <= (unsigned long)x);
801038d5:	39 d8                	cmp    %ebx,%eax
801038d7:	73 f7                	jae    801038d0 <random_at_most+0x20>

  // Truncated division is intentional
  return x/bin_size;
801038d9:	31 d2                	xor    %edx,%edx
801038db:	f7 f6                	div    %esi
801038dd:	5b                   	pop    %ebx
801038de:	5e                   	pop    %esi
801038df:	5d                   	pop    %ebp
801038e0:	c3                   	ret    
801038e1:	eb 0d                	jmp    801038f0 <pinit>
801038e3:	90                   	nop
801038e4:	90                   	nop
801038e5:	90                   	nop
801038e6:	90                   	nop
...
801038f6:	68 75 77 10 80       	push   $0x80107775
801038fb:	68 20 37 11 80       	push   $0x80113720
...
8010391a:	75 5e                	jne    8010397a <mycpu+0x6a>
  apicid = lapicid();
8010391c:	e8 0f ee ff ff       	call   80102730 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103921:	8b 35 00 37 11 80    	mov    0x80113700,%esi
80103927:	85 f6                	test   %esi,%esi
80103929:	7e 42                	jle    8010396d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010392b:	0f b6 15 80 31 11 80 	movzbl 0x80113180,%edx
80103932:	39 d0                	cmp    %edx,%eax
80103934:	74 30                	je     80103966 <mycpu+0x56>
80103936:	b9 30 32 11 80       	mov    $0x80113230,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010395a:	05 80 31 11 80       	add    $0x80113180,%eax
}
...
8010399b:	2d 80 31 11 80       	sub    $0x80113180,%eax
}
801039a0:	c9                   	leave  
  return mycpu()-cpus;
...
801039b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039b7:	e8 d4 0b 00 00       	call   80104590 <pushcli>
  c = mycpu();
801039bc:	e8 4f ff ff ff       	call   80103910 <mycpu>
  p = c->proc;
801039c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c7:	e8 04 0c 00 00       	call   801045d0 <popcli>
}
...
801039e0 <setpriority>:
{
801039e0:	55                   	push   %ebp
801039e1:	89 e5                	mov    %esp,%ebp
801039e3:	56                   	push   %esi
801039e4:	53                   	push   %ebx
801039e5:	8b 75 0c             	mov    0xc(%ebp),%esi
801039e8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(number <= 0)
801039eb:	85 f6                	test   %esi,%esi
801039ed:	0f 8e 87 00 00 00    	jle    80103a7a <setpriority+0x9a>
  if(pid == 0) // make a p
801039f3:	85 db                	test   %ebx,%ebx
801039f5:	74 65                	je     80103a5c <setpriority+0x7c>
    acquire(&ptable.lock);
801039f7:	83 ec 0c             	sub    $0xc,%esp
801039fa:	68 20 37 11 80       	push   $0x80113720
801039ff:	e8 5c 0c 00 00       	call   80104660 <acquire>
80103a04:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103a07:	b8 54 37 11 80       	mov    $0x80113754,%eax
80103a0c:	eb 0e                	jmp    80103a1c <setpriority+0x3c>
80103a0e:	66 90                	xchg   %ax,%ax
80103a10:	05 84 00 00 00       	add    $0x84,%eax
80103a15:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103a1a:	73 24                	jae    80103a40 <setpriority+0x60>
      if(p->pid == pid)
80103a1c:	39 58 14             	cmp    %ebx,0x14(%eax)
80103a1f:	75 ef                	jne    80103a10 <setpriority+0x30>
    release(&ptable.lock);
80103a21:	83 ec 0c             	sub    $0xc,%esp
        p->priority = number;
80103a24:	89 30                	mov    %esi,(%eax)
    release(&ptable.lock);
80103a26:	68 20 37 11 80       	push   $0x80113720
80103a2b:	e8 f0 0c 00 00       	call   80104720 <release>
...
80103a43:	68 20 37 11 80       	push   $0x80113720
80103a48:	e8 d3 0c 00 00       	call   80104720 <release>
...
80103a5b:	c3                   	ret    
  pushcli();
80103a5c:	e8 2f 0b 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103a61:	e8 aa fe ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103a66:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a6c:	e8 5f 0b 00 00       	call   801045d0 <popcli>
    p->priority = number;
80103a71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103a76:	89 33                	mov    %esi,(%ebx)
80103a78:	eb bb                	jmp    80103a35 <setpriority+0x55>
    return -1;
80103a7a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103a7f:	eb b4                	jmp    80103a35 <setpriority+0x55>
80103a81:	eb 0d                	jmp    80103a90 <userinit>
80103a83:	90                   	nop
80103a84:	90                   	nop
80103a85:	90                   	nop
80103a86:	90                   	nop
...
80103a94:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103a97:	e8 64 fb ff ff       	call   80103600 <allocproc>
  p->priority = 1;
80103a9c:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  p = allocproc();
80103aa2:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103aa4:	a3 c0 a5 10 80       	mov    %eax,0x8010a5c0
  if((p->pgdir = setupkvm()) == 0)
80103aa9:	e8 d2 34 00 00       	call   80106f80 <setupkvm>
80103aae:	85 c0                	test   %eax,%eax
80103ab0:	89 43 08             	mov    %eax,0x8(%ebx)
80103ab3:	0f 84 be 00 00 00    	je     80103b77 <userinit+0xe7>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103ab9:	83 ec 04             	sub    $0x4,%esp
80103abc:	68 2c 00 00 00       	push   $0x2c
80103ac1:	68 60 a4 10 80       	push   $0x8010a460
80103ac6:	50                   	push   %eax
80103ac7:	e8 94 31 00 00       	call   80106c60 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103acc:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103acf:	c7 43 04 00 10 00 00 	movl   $0x1000,0x4(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103ad6:	6a 4c                	push   $0x4c
80103ad8:	6a 00                	push   $0x0
80103ada:	ff 73 1c             	pushl  0x1c(%ebx)
80103add:	e8 8e 0c 00 00       	call   80104770 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103ae2:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103ae5:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103aea:	b9 23 00 00 00       	mov    $0x23,%ecx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103aef:	83 c4 0c             	add    $0xc,%esp
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103af2:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103af6:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103af9:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103afd:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b00:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103b04:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103b08:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b0b:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103b0f:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103b13:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b16:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103b1d:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b20:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103b27:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103b2a:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103b31:	8d 43 70             	lea    0x70(%ebx),%eax
80103b34:	6a 10                	push   $0x10
80103b36:	68 a5 77 10 80       	push   $0x801077a5
80103b3b:	50                   	push   %eax
80103b3c:	e8 0f 0e 00 00       	call   80104950 <safestrcpy>
  p->cwd = namei("/");
80103b41:	c7 04 24 ae 77 10 80 	movl   $0x801077ae,(%esp)
80103b48:	e8 93 e3 ff ff       	call   80101ee0 <namei>
80103b4d:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103b50:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103b57:	e8 04 0b 00 00       	call   80104660 <acquire>
  p->state = RUNNABLE;
80103b5c:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
80103b63:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103b6a:	e8 b1 0b 00 00       	call   80104720 <release>
}
80103b6f:	83 c4 10             	add    $0x10,%esp
80103b72:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103b75:	c9                   	leave  
80103b76:	c3                   	ret    
    panic("userinit: out of memory?");
80103b77:	83 ec 0c             	sub    $0xc,%esp
80103b7a:	68 8c 77 10 80       	push   $0x8010778c
...
80103b95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b98:	e8 f3 09 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103b9d:	e8 6e fd ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103ba2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ba8:	e8 23 0a 00 00       	call   801045d0 <popcli>
  if(n > 0){
80103bad:	83 fe 00             	cmp    $0x0,%esi
  sz = curproc->sz;
80103bb0:	8b 43 04             	mov    0x4(%ebx),%eax
  if(n > 0){
80103bb3:	7f 1b                	jg     80103bd0 <growproc+0x40>
  } else if(n < 0){
80103bb5:	75 39                	jne    80103bf0 <growproc+0x60>
  switchuvm(curproc);
...
80103bbe:	e8 8d 2f 00 00       	call   80106b50 <switchuvm>
  return 0;
...
80103bd7:	ff 73 08             	pushl  0x8(%ebx)
80103bda:	e8 c1 31 00 00       	call   80106da0 <allocuvm>
80103bdf:	83 c4 10             	add    $0x10,%esp
80103be2:	85 c0                	test   %eax,%eax
80103be4:	75 d1                	jne    80103bb7 <growproc+0x27>
      return -1;
80103be6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103beb:	eb db                	jmp    80103bc8 <growproc+0x38>
...
80103bf7:	ff 73 08             	pushl  0x8(%ebx)
80103bfa:	e8 d1 32 00 00       	call   80106ed0 <deallocuvm>
80103bff:	83 c4 10             	add    $0x10,%esp
80103c02:	85 c0                	test   %eax,%eax
80103c04:	75 b1                	jne    80103bb7 <growproc+0x27>
...
80103c16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c19:	e8 72 09 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103c1e:	e8 ed fc ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103c23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c29:	e8 a2 09 00 00       	call   801045d0 <popcli>
  if((np = allocproc()) == 0){
80103c2e:	e8 cd f9 ff ff       	call   80103600 <allocproc>
80103c33:	85 c0                	test   %eax,%eax
80103c35:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103c38:	0f 84 d7 00 00 00    	je     80103d15 <fork+0x105>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103c3e:	83 ec 08             	sub    $0x8,%esp
80103c41:	ff 73 04             	pushl  0x4(%ebx)
80103c44:	ff 73 08             	pushl  0x8(%ebx)
80103c47:	89 c7                	mov    %eax,%edi
80103c49:	e8 02 34 00 00       	call   80107050 <copyuvm>
80103c4e:	83 c4 10             	add    $0x10,%esp
80103c51:	85 c0                	test   %eax,%eax
80103c53:	89 47 08             	mov    %eax,0x8(%edi)
80103c56:	0f 84 c0 00 00 00    	je     80103d1c <fork+0x10c>
  np->sz = curproc->sz;
80103c5c:	8b 43 04             	mov    0x4(%ebx),%eax
80103c5f:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  setpriority(np->pid, curproc->priority);
80103c62:	83 ec 08             	sub    $0x8,%esp
  np->sz = curproc->sz;
80103c65:	89 41 04             	mov    %eax,0x4(%ecx)
  np->parent = curproc;
80103c68:	89 59 18             	mov    %ebx,0x18(%ecx)
80103c6b:	89 c8                	mov    %ecx,%eax
  *np->tf = *curproc->tf;
80103c6d:	8b 79 1c             	mov    0x1c(%ecx),%edi
80103c70:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103c73:	b9 13 00 00 00       	mov    $0x13,%ecx
80103c78:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  setpriority(np->pid, curproc->priority);
80103c7a:	89 c7                	mov    %eax,%edi
  for(i = 0; i < NOFILE; i++)
80103c7c:	31 f6                	xor    %esi,%esi
  setpriority(np->pid, curproc->priority);
80103c7e:	ff 33                	pushl  (%ebx)
80103c80:	ff 70 14             	pushl  0x14(%eax)
80103c83:	e8 58 fd ff ff       	call   801039e0 <setpriority>
  np->tf->eax = 0;
80103c88:	8b 47 1c             	mov    0x1c(%edi),%eax
  np->ticks=0;
80103c8b:	c7 87 80 00 00 00 00 	movl   $0x0,0x80(%edi)
80103c92:	00 00 00 
  np->tf->eax = 0;
80103c95:	83 c4 10             	add    $0x10,%esp
80103c98:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
80103c9f:	90                   	nop
    if(curproc->ofile[i])
80103ca0:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103ca4:	85 c0                	test   %eax,%eax
80103ca6:	74 13                	je     80103cbb <fork+0xab>
...
80103cb7:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103cbb:	83 c6 01             	add    $0x1,%esi
80103cbe:	83 fe 10             	cmp    $0x10,%esi
80103cc1:	75 dd                	jne    80103ca0 <fork+0x90>
  np->cwd = idup(curproc->cwd);
80103cc3:	83 ec 0c             	sub    $0xc,%esp
80103cc6:	ff 73 6c             	pushl  0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cc9:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
...
80103cd4:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103cd7:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cda:	8d 47 70             	lea    0x70(%edi),%eax
80103cdd:	6a 10                	push   $0x10
80103cdf:	53                   	push   %ebx
80103ce0:	50                   	push   %eax
80103ce1:	e8 6a 0c 00 00       	call   80104950 <safestrcpy>
  pid = np->pid;
80103ce6:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
80103ce9:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103cf0:	e8 6b 09 00 00       	call   80104660 <acquire>
  np->state = RUNNABLE;
80103cf5:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)
  release(&ptable.lock);
80103cfc:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103d03:	e8 18 0a 00 00       	call   80104720 <release>
  return pid;
...
80103d1a:	eb ef                	jmp    80103d0b <fork+0xfb>
    kfree(np->kstack);
80103d1c:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103d1f:	83 ec 0c             	sub    $0xc,%esp
80103d22:	ff 73 0c             	pushl  0xc(%ebx)
80103d25:	e8 e6 e5 ff ff       	call   80102310 <kfree>
    np->kstack = 0;
80103d2a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    np->state = UNUSED;
80103d31:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
80103d38:	83 c4 10             	add    $0x10,%esp
80103d3b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103d40:	eb c9                	jmp    80103d0b <fork+0xfb>
...
80103d5e:	8d 70 04             	lea    0x4(%eax),%esi
...
80103d74:	31 ff                	xor    %edi,%edi
    acquire(&ptable.lock);
80103d76:	68 20 37 11 80       	push   $0x80113720
80103d7b:	e8 e0 08 00 00       	call   80104660 <acquire>
80103d80:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d83:	b8 54 37 11 80       	mov    $0x80113754,%eax
80103d88:	90                   	nop
80103d89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->state != RUNNABLE)
80103d90:	83 78 10 03          	cmpl   $0x3,0x10(%eax)
80103d94:	75 02                	jne    80103d98 <scheduler+0x48>
      total=total+p->priority;
80103d96:	03 38                	add    (%eax),%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d98:	05 84 00 00 00       	add    $0x84,%eax
80103d9d:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103da2:	72 ec                	jb     80103d90 <scheduler+0x40>
    if(total == 0)
80103da4:	85 ff                	test   %edi,%edi
80103da6:	74 6e                	je     80103e16 <scheduler+0xc6>
    rNum = genrand() % total;
80103da8:	e8 b3 f9 ff ff       	call   80103760 <genrand>
80103dad:	99                   	cltd   
80103dae:	f7 ff                	idiv   %edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103db0:	bf 54 37 11 80       	mov    $0x80113754,%edi
80103db5:	eb 19                	jmp    80103dd0 <scheduler+0x80>
80103db7:	89 f6                	mov    %esi,%esi
80103db9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        rNum -= p->priority;
80103dc0:	29 c2                	sub    %eax,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dc2:	81 c7 84 00 00 00    	add    $0x84,%edi
80103dc8:	81 ff 54 58 11 80    	cmp    $0x80115854,%edi
80103dce:	73 46                	jae    80103e16 <scheduler+0xc6>
      if(p->state != RUNNABLE)
80103dd0:	83 7f 10 03          	cmpl   $0x3,0x10(%edi)
80103dd4:	75 ec                	jne    80103dc2 <scheduler+0x72>
      else if(p->priority <= rNum)
80103dd6:	8b 07                	mov    (%edi),%eax
80103dd8:	39 d0                	cmp    %edx,%eax
80103dda:	7e e4                	jle    80103dc0 <scheduler+0x70>
        switchuvm(p);
80103ddc:	83 ec 0c             	sub    $0xc,%esp
        c->proc = p;
80103ddf:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
        switchuvm(p);
80103de5:	57                   	push   %edi
80103de6:	e8 65 2d 00 00       	call   80106b50 <switchuvm>
        p->ticks++;
80103deb:	83 87 80 00 00 00 01 	addl   $0x1,0x80(%edi)
        p->state = RUNNING;
80103df2:	c7 47 10 04 00 00 00 	movl   $0x4,0x10(%edi)
        swtch(&(c->scheduler), p->context);
80103df9:	58                   	pop    %eax
80103dfa:	5a                   	pop    %edx
80103dfb:	ff 77 20             	pushl  0x20(%edi)
80103dfe:	56                   	push   %esi
80103dff:	e8 a7 0b 00 00       	call   801049ab <swtch>
        switchkvm();
80103e04:	e8 27 2d 00 00       	call   80106b30 <switchkvm>
        c->proc = 0;
80103e09:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103e10:	00 00 00 
        break;
80103e13:	83 c4 10             	add    $0x10,%esp
      release(&ptable.lock);
80103e16:	83 ec 0c             	sub    $0xc,%esp
80103e19:	68 20 37 11 80       	push   $0x80113720
80103e1e:	e8 fd 08 00 00       	call   80104720 <release>
      continue;
80103e23:	83 c4 10             	add    $0x10,%esp
80103e26:	e9 45 ff ff ff       	jmp    80103d70 <scheduler+0x20>
80103e2b:	90                   	nop
...
80103e34:	53                   	push   %ebx
  pushcli();
80103e35:	e8 56 07 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103e3a:	e8 d1 fa ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103e3f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e45:	e8 86 07 00 00       	call   801045d0 <popcli>
  if(!holding(&ptable.lock))
80103e4a:	83 ec 0c             	sub    $0xc,%esp
80103e4d:	68 20 37 11 80       	push   $0x80113720
80103e52:	e8 d9 07 00 00       	call   80104630 <holding>
...
80103e6a:	75 68                	jne    80103ed4 <sched+0xa4>
  if(p->state == RUNNING)
80103e6c:	83 7b 10 04          	cmpl   $0x4,0x10(%ebx)
...
80103e77:	75 41                	jne    80103eba <sched+0x8a>
  intena = mycpu()->intena;
80103e79:	e8 92 fa ff ff       	call   80103910 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e7e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
80103e81:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e87:	e8 84 fa ff ff       	call   80103910 <mycpu>
80103e8c:	83 ec 08             	sub    $0x8,%esp
80103e8f:	ff 70 04             	pushl  0x4(%eax)
80103e92:	53                   	push   %ebx
80103e93:	e8 13 0b 00 00       	call   801049ab <swtch>
  mycpu()->intena = intena;
80103e98:	e8 73 fa ff ff       	call   80103910 <mycpu>
}
...
80103ef6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103ef9:	e8 92 06 00 00       	call   80104590 <pushcli>
  c = mycpu();
80103efe:	e8 0d fa ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f03:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f09:	e8 c2 06 00 00       	call   801045d0 <popcli>
  if(curproc == initproc)
80103f0e:	39 35 c0 a5 10 80    	cmp    %esi,0x8010a5c0
80103f14:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103f17:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103f2a:	e8 11 cf ff ff       	call   80100e40 <fileclose>
      curproc->ofile[fd] = 0;
80103f2f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80103f35:	83 c4 10             	add    $0x10,%esp
80103f38:	83 c3 04             	add    $0x4,%ebx
  for(fd = 0; fd < NOFILE; fd++){
80103f3b:	39 fb                	cmp    %edi,%ebx
80103f3d:	75 e1                	jne    80103f20 <exit+0x30>
  begin_op();
80103f3f:	e8 5c ec ff ff       	call   80102ba0 <begin_op>
  iput(curproc->cwd);
80103f44:	83 ec 0c             	sub    $0xc,%esp
80103f47:	ff 76 6c             	pushl  0x6c(%esi)
80103f4a:	e8 61 d8 ff ff       	call   801017b0 <iput>
  end_op();
80103f4f:	e8 bc ec ff ff       	call   80102c10 <end_op>
  curproc->cwd = 0;
80103f54:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  acquire(&ptable.lock);
80103f5b:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80103f62:	e8 f9 06 00 00       	call   80104660 <acquire>
  wakeup1(curproc->parent);
80103f67:	8b 56 18             	mov    0x18(%esi),%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f6d:	b8 54 37 11 80       	mov    $0x80113754,%eax
80103f72:	eb 10                	jmp    80103f84 <exit+0x94>
80103f74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f78:	05 84 00 00 00       	add    $0x84,%eax
80103f7d:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103f82:	73 1e                	jae    80103fa2 <exit+0xb2>
    if(p->state == SLEEPING && p->chan == chan)
80103f84:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103f88:	75 ee                	jne    80103f78 <exit+0x88>
80103f8a:	3b 50 24             	cmp    0x24(%eax),%edx
80103f8d:	75 e9                	jne    80103f78 <exit+0x88>
      p->state = RUNNABLE;
80103f8f:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f96:	05 84 00 00 00       	add    $0x84,%eax
80103f9b:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103fa0:	72 e2                	jb     80103f84 <exit+0x94>
      p->parent = initproc;
80103fa2:	8b 0d c0 a5 10 80    	mov    0x8010a5c0,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa8:	ba 54 37 11 80       	mov    $0x80113754,%edx
80103fad:	eb 0f                	jmp    80103fbe <exit+0xce>
80103faf:	90                   	nop
80103fb0:	81 c2 84 00 00 00    	add    $0x84,%edx
80103fb6:	81 fa 54 58 11 80    	cmp    $0x80115854,%edx
80103fbc:	73 3a                	jae    80103ff8 <exit+0x108>
    if(p->parent == curproc){
80103fbe:	39 72 18             	cmp    %esi,0x18(%edx)
80103fc1:	75 ed                	jne    80103fb0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103fc3:	83 7a 10 05          	cmpl   $0x5,0x10(%edx)
      p->parent = initproc;
80103fc7:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
80103fca:	75 e4                	jne    80103fb0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fcc:	b8 54 37 11 80       	mov    $0x80113754,%eax
80103fd1:	eb 11                	jmp    80103fe4 <exit+0xf4>
80103fd3:	90                   	nop
80103fd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fd8:	05 84 00 00 00       	add    $0x84,%eax
80103fdd:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80103fe2:	73 cc                	jae    80103fb0 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
80103fe4:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80103fe8:	75 ee                	jne    80103fd8 <exit+0xe8>
80103fea:	3b 48 24             	cmp    0x24(%eax),%ecx
80103fed:	75 e9                	jne    80103fd8 <exit+0xe8>
      p->state = RUNNABLE;
80103fef:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
80103ff6:	eb e0                	jmp    80103fd8 <exit+0xe8>
  curproc->state = ZOMBIE;
80103ff8:	c7 46 10 05 00 00 00 	movl   $0x5,0x10(%esi)
  sched();
80103fff:	e8 2c fe ff ff       	call   80103e30 <sched>
  panic("zombie exit");
80104004:	83 ec 0c             	sub    $0xc,%esp
80104007:	68 fd 77 10 80       	push   $0x801077fd
8010400c:	e8 7f c3 ff ff       	call   80100390 <panic>
    panic("init exiting");
80104011:	83 ec 0c             	sub    $0xc,%esp
80104014:	68 f0 77 10 80       	push   $0x801077f0
80104019:	e8 72 c3 ff ff       	call   80100390 <panic>
...
80104027:	68 20 37 11 80       	push   $0x80113720
8010402c:	e8 2f 06 00 00       	call   80104660 <acquire>
  pushcli();
80104031:	e8 5a 05 00 00       	call   80104590 <pushcli>
  c = mycpu();
80104036:	e8 d5 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
8010403b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104041:	e8 8a 05 00 00       	call   801045d0 <popcli>
  myproc()->state = RUNNABLE;
80104046:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
8010404d:	e8 de fd ff ff       	call   80103e30 <sched>
  release(&ptable.lock);
80104052:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
80104059:	e8 c2 06 00 00       	call   80104720 <release>
}
...
8010407c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010407f:	e8 0c 05 00 00       	call   80104590 <pushcli>
  c = mycpu();
80104084:	e8 87 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80104089:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010408f:	e8 3c 05 00 00       	call   801045d0 <popcli>
  if(p == 0)
...
801040a0:	81 fe 20 37 11 80    	cmp    $0x80113720,%esi
801040a6:	74 50                	je     801040f8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801040a8:	83 ec 0c             	sub    $0xc,%esp
801040ab:	68 20 37 11 80       	push   $0x80113720
801040b0:	e8 ab 05 00 00       	call   80104660 <acquire>
    release(lk);
801040b5:	89 34 24             	mov    %esi,(%esp)
801040b8:	e8 63 06 00 00       	call   80104720 <release>
  p->chan = chan;
801040bd:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
801040c0:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
801040c7:	e8 64 fd ff ff       	call   80103e30 <sched>
  p->chan = 0;
801040cc:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
801040d3:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
801040da:	e8 41 06 00 00       	call   80104720 <release>
    acquire(lk);
...
801040eb:	5d                   	pop    %ebp
    acquire(lk);
801040ec:	e9 6f 05 00 00       	jmp    80104660 <acquire>
801040f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
801040f8:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
801040fb:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
80104119:	68 0f 78 10 80       	push   $0x8010780f
8010411e:	e8 6d c2 ff ff       	call   80100390 <panic>
    panic("sleep");
80104123:	83 ec 0c             	sub    $0xc,%esp
80104126:	68 09 78 10 80       	push   $0x80107809
...
80104134:	53                   	push   %ebx
  pushcli();
80104135:	e8 56 04 00 00       	call   80104590 <pushcli>
  c = mycpu();
8010413a:	e8 d1 f7 ff ff       	call   80103910 <mycpu>
  p = c->proc;
8010413f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104145:	e8 86 04 00 00       	call   801045d0 <popcli>
  acquire(&ptable.lock);
8010414a:	83 ec 0c             	sub    $0xc,%esp
8010414d:	68 20 37 11 80       	push   $0x80113720
80104152:	e8 09 05 00 00       	call   80104660 <acquire>
80104157:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010415a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010415c:	bb 54 37 11 80       	mov    $0x80113754,%ebx
80104161:	eb 13                	jmp    80104176 <wait+0x46>
80104163:	90                   	nop
80104164:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104168:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010416e:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
80104174:	73 1e                	jae    80104194 <wait+0x64>
      if(p->parent != curproc)
80104176:	39 73 18             	cmp    %esi,0x18(%ebx)
80104179:	75 ed                	jne    80104168 <wait+0x38>
      if(p->state == ZOMBIE){
8010417b:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
8010417f:	74 37                	je     801041b8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104181:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80104187:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010418c:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
80104192:	72 e2                	jb     80104176 <wait+0x46>
    if(!havekids || curproc->killed){
80104194:	85 c0                	test   %eax,%eax
80104196:	74 76                	je     8010420e <wait+0xde>
80104198:	8b 46 28             	mov    0x28(%esi),%eax
8010419b:	85 c0                	test   %eax,%eax
8010419d:	75 6f                	jne    8010420e <wait+0xde>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
8010419f:	83 ec 08             	sub    $0x8,%esp
801041a2:	68 20 37 11 80       	push   $0x80113720
801041a7:	56                   	push   %esi
801041a8:	e8 c3 fe ff ff       	call   80104070 <sleep>
    havekids = 0;
801041ad:	83 c4 10             	add    $0x10,%esp
801041b0:	eb a8                	jmp    8010415a <wait+0x2a>
801041b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
801041b8:	83 ec 0c             	sub    $0xc,%esp
801041bb:	ff 73 0c             	pushl  0xc(%ebx)
        pid = p->pid;
801041be:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
801041c1:	e8 4a e1 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
801041c6:	5a                   	pop    %edx
801041c7:	ff 73 08             	pushl  0x8(%ebx)
        p->kstack = 0;
801041ca:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
801041d1:	e8 2a 2d 00 00       	call   80106f00 <freevm>
        release(&ptable.lock);
801041d6:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
        p->pid = 0;
801041dd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
801041e4:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
801041eb:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
801041ef:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
801041f6:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
801041fd:	e8 1e 05 00 00       	call   80104720 <release>
        return pid;
80104202:	83 c4 10             	add    $0x10,%esp
}
80104205:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104208:	89 f0                	mov    %esi,%eax
8010420a:	5b                   	pop    %ebx
8010420b:	5e                   	pop    %esi
8010420c:	5d                   	pop    %ebp
8010420d:	c3                   	ret    
...
8010420e:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104211:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104216:	68 20 37 11 80       	push   $0x80113720
8010421b:	e8 00 05 00 00       	call   80104720 <release>
      return -1;
80104220:	83 c4 10             	add    $0x10,%esp
80104223:	eb e0                	jmp    80104205 <wait+0xd5>
...
80104237:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010423a:	68 20 37 11 80       	push   $0x80113720
8010423f:	e8 1c 04 00 00       	call   80104660 <acquire>
80104244:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104247:	b8 54 37 11 80       	mov    $0x80113754,%eax
8010424c:	eb 0e                	jmp    8010425c <wakeup+0x2c>
8010424e:	66 90                	xchg   %ax,%ax
80104250:	05 84 00 00 00       	add    $0x84,%eax
80104255:	3d 54 58 11 80       	cmp    $0x80115854,%eax
8010425a:	73 1e                	jae    8010427a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010425c:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
80104260:	75 ee                	jne    80104250 <wakeup+0x20>
80104262:	3b 58 24             	cmp    0x24(%eax),%ebx
80104265:	75 e9                	jne    80104250 <wakeup+0x20>
      p->state = RUNNABLE;
80104267:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010426e:	05 84 00 00 00       	add    $0x84,%eax
80104273:	3d 54 58 11 80       	cmp    $0x80115854,%eax
80104278:	72 e2                	jb     8010425c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010427a:	c7 45 08 20 37 11 80 	movl   $0x80113720,0x8(%ebp)
}
80104281:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104284:	c9                   	leave  
  release(&ptable.lock);
80104285:	e9 96 04 00 00       	jmp    80104720 <release>
...
80104297:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010429a:	68 20 37 11 80       	push   $0x80113720
8010429f:	e8 bc 03 00 00       	call   80104660 <acquire>
801042a4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042a7:	b8 54 37 11 80       	mov    $0x80113754,%eax
801042ac:	eb 0e                	jmp    801042bc <kill+0x2c>
801042ae:	66 90                	xchg   %ax,%ax
801042b0:	05 84 00 00 00       	add    $0x84,%eax
801042b5:	3d 54 58 11 80       	cmp    $0x80115854,%eax
801042ba:	73 34                	jae    801042f0 <kill+0x60>
    if(p->pid == pid){
...
801042cc:	75 07                	jne    801042d5 <kill+0x45>
        p->state = RUNNABLE;
801042ce:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
801042d5:	83 ec 0c             	sub    $0xc,%esp
801042d8:	68 20 37 11 80       	push   $0x80113720
801042dd:	e8 3e 04 00 00       	call   80104720 <release>
      return 0;
...
801042f3:	68 20 37 11 80       	push   $0x80113720
801042f8:	e8 23 04 00 00       	call   80104720 <release>
  return -1;
...
80104316:	8d 75 e8             	lea    -0x18(%ebp),%esi
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104319:	bb 54 37 11 80       	mov    $0x80113754,%ebx
{
...
8010432b:	68 9b 7b 10 80       	push   $0x80107b9b
80104330:	e8 2b c3 ff ff       	call   80100660 <cprintf>
80104335:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104338:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010433e:	81 fb 54 58 11 80    	cmp    $0x80115854,%ebx
80104344:	0f 83 96 00 00 00    	jae    801043e0 <procdump+0xd0>
    if(p->state == UNUSED)
8010434a:	8b 43 10             	mov    0x10(%ebx),%eax
8010434d:	85 c0                	test   %eax,%eax
8010434f:	74 e7                	je     80104338 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104351:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104354:	ba 20 78 10 80       	mov    $0x80107820,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104359:	77 11                	ja     8010436c <procdump+0x5c>
8010435b:	8b 14 85 88 78 10 80 	mov    -0x7fef8778(,%eax,4),%edx
      state = "???";
80104362:	b8 20 78 10 80       	mov    $0x80107820,%eax
80104367:	85 d2                	test   %edx,%edx
80104369:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s (%d,%d)", p->pid, state, p->name, p->priority, p->ticks);
8010436c:	8d 43 70             	lea    0x70(%ebx),%eax
8010436f:	83 ec 08             	sub    $0x8,%esp
80104372:	ff b3 80 00 00 00    	pushl  0x80(%ebx)
80104378:	ff 33                	pushl  (%ebx)
8010437a:	50                   	push   %eax
8010437b:	52                   	push   %edx
8010437c:	ff 73 14             	pushl  0x14(%ebx)
8010437f:	68 24 78 10 80       	push   $0x80107824
80104384:	e8 d7 c2 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
80104389:	83 c4 20             	add    $0x20,%esp
8010438c:	83 7b 10 02          	cmpl   $0x2,0x10(%ebx)
80104390:	75 96                	jne    80104328 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104392:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104395:	83 ec 08             	sub    $0x8,%esp
80104398:	8d 7d c0             	lea    -0x40(%ebp),%edi
8010439b:	50                   	push   %eax
8010439c:	8b 43 20             	mov    0x20(%ebx),%eax
8010439f:	8b 40 0c             	mov    0xc(%eax),%eax
801043a2:	83 c0 08             	add    $0x8,%eax
801043a5:	50                   	push   %eax
801043a6:	e8 95 01 00 00       	call   80104540 <getcallerpcs>
801043ab:	83 c4 10             	add    $0x10,%esp
801043ae:	66 90                	xchg   %ax,%ax
      for(i=0; i<10 && pc[i] != 0; i++)
801043b0:	8b 17                	mov    (%edi),%edx
801043b2:	85 d2                	test   %edx,%edx
801043b4:	0f 84 6e ff ff ff    	je     80104328 <procdump+0x18>
        cprintf(" %p", pc[i]);
801043ba:	83 ec 08             	sub    $0x8,%esp
801043bd:	83 c7 04             	add    $0x4,%edi
801043c0:	52                   	push   %edx
801043c1:	68 61 72 10 80       	push   $0x80107261
801043c6:	e8 95 c2 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801043cb:	83 c4 10             	add    $0x10,%esp
801043ce:	39 fe                	cmp    %edi,%esi
801043d0:	75 de                	jne    801043b0 <procdump+0xa0>
801043d2:	e9 51 ff ff ff       	jmp    80104328 <procdump+0x18>
...
801043fa:	68 a8 78 10 80       	push   $0x801078a8
...
80104455:	e8 16 fc ff ff       	call   80104070 <sleep>
  while (lk->locked) {
...
80104463:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104469:	e8 42 f5 ff ff       	call   801039b0 <myproc>
...
801044b4:	e8 77 fd ff ff       	call   80104230 <wakeup>
  release(&lk->lk);
...
801044f3:	e8 b8 f4 ff ff       	call   801039b0 <myproc>
801044f8:	39 58 14             	cmp    %ebx,0x14(%eax)
...
80104599:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010459a:	e8 71 f3 ff ff       	call   80103910 <mycpu>
...
801045af:	e8 5c f3 ff ff       	call   80103910 <mycpu>
...
80104615:	68 b3 78 10 80       	push   $0x801078b3
8010461a:	e8 71 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010461f:	83 ec 0c             	sub    $0xc,%esp
80104622:	68 ca 78 10 80       	push   $0x801078ca
...
80104648:	e8 c3 f2 ff ff       	call   80103910 <mycpu>
...
801046a4:	e8 67 f2 ff ff       	call   80103910 <mycpu>
...
80104707:	68 d1 78 10 80       	push   $0x801078d1
...
8010475c:	68 d9 78 10 80       	push   $0x801078d9
...
801049c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ca:	e8 e1 ef ff ff       	call   801039b0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801049cf:	8b 40 04             	mov    0x4(%eax),%eax
801049d2:	39 d8                	cmp    %ebx,%eax
801049d4:	76 1a                	jbe    801049f0 <fetchint+0x30>
801049d6:	8d 53 04             	lea    0x4(%ebx),%edx
801049d9:	39 d0                	cmp    %edx,%eax
801049db:	72 13                	jb     801049f0 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
801049dd:	8b 45 0c             	mov    0xc(%ebp),%eax
801049e0:	8b 13                	mov    (%ebx),%edx
...
801049f5:	eb ef                	jmp    801049e6 <fetchint+0x26>
...
80104a07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a0a:	e8 a1 ef ff ff       	call   801039b0 <myproc>

  if(addr >= curproc->sz)
80104a0f:	39 58 04             	cmp    %ebx,0x4(%eax)
80104a12:	76 28                	jbe    80104a3c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104a14:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104a17:	89 da                	mov    %ebx,%edx
80104a19:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80104a1b:	8b 40 04             	mov    0x4(%eax),%eax
  for(s = *pp; s < ep; s++){
80104a1e:	39 c3                	cmp    %eax,%ebx
80104a20:	73 1a                	jae    80104a3c <fetchstr+0x3c>
    if(*s == 0)
80104a22:	80 3b 00             	cmpb   $0x0,(%ebx)
80104a25:	75 0e                	jne    80104a35 <fetchstr+0x35>
80104a27:	eb 37                	jmp    80104a60 <fetchstr+0x60>
...
80104a75:	e8 36 ef ff ff       	call   801039b0 <myproc>
80104a7a:	8b 40 1c             	mov    0x1c(%eax),%eax
80104a7d:	8b 55 08             	mov    0x8(%ebp),%edx
80104a80:	8b 40 44             	mov    0x44(%eax),%eax
80104a83:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a86:	e8 25 ef ff ff       	call   801039b0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104a8b:	8b 40 04             	mov    0x4(%eax),%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a8e:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104a91:	39 c6                	cmp    %eax,%esi
80104a93:	73 1b                	jae    80104ab0 <argint+0x40>
80104a95:	8d 53 08             	lea    0x8(%ebx),%edx
80104a98:	39 d0                	cmp    %edx,%eax
80104a9a:	72 14                	jb     80104ab0 <argint+0x40>
  *ip = *(int*)(addr);
80104a9c:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a9f:	8b 53 04             	mov    0x4(%ebx),%edx
80104aa2:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104ab0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ab5:	eb ef                	jmp    80104aa6 <argint+0x36>
...
80104ac8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104acb:	e8 e0 ee ff ff       	call   801039b0 <myproc>
...
80104aec:	8b 56 04             	mov    0x4(%esi),%edx
80104aef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af2:	39 c2                	cmp    %eax,%edx
80104af4:	76 1a                	jbe    80104b10 <argptr+0x50>
80104af6:	01 c3                	add    %eax,%ebx
80104af8:	39 da                	cmp    %ebx,%edx
80104afa:	72 14                	jb     80104b10 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104afc:	8b 55 0c             	mov    0xc(%ebp),%edx
80104aff:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104b15:	eb ec                	jmp    80104b03 <argptr+0x43>
...
80104b64:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b67:	e8 44 ee ff ff       	call   801039b0 <myproc>
80104b6c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104b6e:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104b9d:	ff 73 14             	pushl  0x14(%ebx)
80104ba0:	68 e1 78 10 80       	push   $0x801078e1
80104ba5:	e8 b6 ba ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
80104baa:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104bd7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104bda:	e8 21 d3 ff ff       	call   80101f00 <nameiparent>
...
80104bfc:	e8 af cf ff ff       	call   80101bb0 <dirlookup>
80104c01:	83 c4 10             	add    $0x10,%esp
80104c04:	85 c0                	test   %eax,%eax
80104c06:	89 c7                	mov    %eax,%edi
80104c08:	74 36                	je     80104c40 <create+0x80>
    iunlockput(dp);
80104c0a:	83 ec 0c             	sub    $0xc,%esp
80104c0d:	53                   	push   %ebx
80104c0e:	e8 fd cc ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104c13:	89 3c 24             	mov    %edi,(%esp)
80104c16:	e8 65 ca ff ff       	call   80101680 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104c1b:	83 c4 10             	add    $0x10,%esp
80104c1e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104c23:	0f 85 97 00 00 00    	jne    80104cc0 <create+0x100>
80104c29:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
80104c2e:	0f 85 8c 00 00 00    	jne    80104cc0 <create+0x100>
...
80104cac:	e8 5f cc ff ff       	call   80101910 <iunlockput>
  return ip;
...
80104cc4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104cc6:	e8 45 cc ff ff       	call   80101910 <iunlockput>
    return 0;
...
80104ce9:	e8 e2 c8 ff ff       	call   801015d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104cee:	83 c4 0c             	add    $0xc,%esp
80104cf1:	ff 77 04             	pushl  0x4(%edi)
80104cf4:	68 78 79 10 80       	push   $0x80107978
80104cf9:	57                   	push   %edi
80104cfa:	e8 21 d1 ff ff       	call   80101e20 <dirlink>
...
80104d0c:	68 77 79 10 80       	push   $0x80107977
80104d11:	57                   	push   %edi
80104d12:	e8 09 d1 ff ff       	call   80101e20 <dirlink>
...
80104d84:	e8 27 ec ff ff       	call   801039b0 <myproc>
...
80104f13:	78 2b                	js     80104f40 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f15:	e8 96 ea ff ff       	call   801039b0 <myproc>
...
80104fd2:	0f 88 e2 00 00 00    	js     801050ba <sys_link+0x11a>
  begin_op();
80104fd8:	e8 c3 db ff ff       	call   80102ba0 <begin_op>
  if((ip = namei(old)) == 0){
80104fdd:	83 ec 0c             	sub    $0xc,%esp
80104fe0:	ff 75 d4             	pushl  -0x2c(%ebp)
80104fe3:	e8 f8 ce ff ff       	call   80101ee0 <namei>
...
8010502b:	e8 d0 ce ff ff       	call   80101f00 <nameiparent>
...
80105053:	e8 c8 cd ff ff       	call   80101e20 <dirlink>
...
801050ad:	e8 5e c8 ff ff       	call   80101910 <iunlockput>
  end_op();
801050b2:	e8 59 db ff ff       	call   80102c10 <end_op>
  return -1;
...
801050dd:	eb 9b                	jmp    8010507a <sys_link+0xda>
    end_op();
801050df:	e8 2c db ff ff       	call   80102c10 <end_op>
    return -1;
...
8010510f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105112:	e8 89 da ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80105139:	58                   	pop    %eax
8010513a:	5a                   	pop    %edx
8010513b:	68 78 79 10 80       	push   $0x80107978
...
80105154:	68 77 79 10 80       	push   $0x80107977
...
801051f2:	e8 19 c7 ff ff       	call   80101910 <iunlockput>
  end_op();
801051f7:	e8 14 da ff ff       	call   80102c10 <end_op>
  return 0;
...
80105258:	e8 b3 c6 ff ff       	call   80101910 <iunlockput>
  end_op();
8010525d:	e8 ae d9 ff ff       	call   80102c10 <end_op>
  return -1;
...
80105302:	0f 88 04 01 00 00    	js     8010540c <sys_open+0x13c>
  ...
  begin_op();
80105308:	e8 93 d8 ff ff       	call   80102ba0 <begin_op>
...
8010531d:	e8 be cb ff ff       	call   80101ee0 <namei>
...
8010534f:	0f 84 a6 00 00 00    	je     801053fb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105355:	e8 56 e6 ff ff       	call   801039b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010537c:	e8 df c3 ff ff       	call   80101760 <iunlock>
  end_op();
...
8010546f:	e8 9c c4 ff ff       	call   80101910 <iunlockput>
  end_op();
80105474:	e8 97 d7 ff ff       	call   80102c10 <end_op>
  return 0;
...
801054fe:	e8 0d c4 ff ff       	call   80101910 <iunlockput>
  end_op();
80105503:	e8 08 d7 ff ff       	call   80102c10 <end_op>
  return 0;
...
80105525:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105528:	e8 83 e4 ff ff       	call   801039b0 <myproc>
8010552d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010552f:	e8 6c d6 ff ff       	call   80102ba0 <begin_op>
...
8010554f:	e8 8c c9 ff ff       	call   80101ee0 <namei>
...
8010557d:	e8 2e c2 ff ff       	call   801017b0 <iput>
  end_op();
80105582:	e8 89 d6 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
...
801055a4:	e8 67 c3 ff ff       	call   80101910 <iunlockput>
    end_op();
801055a9:	e8 62 d6 ff ff       	call   80102c10 <end_op>
    return -1;
...
801056ec:	e8 4f db ff ff       	call   80103240 <pipealloc>
...
801056ff:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105701:	e8 aa e2 ff ff       	call   801039b0 <myproc>
...
80105727:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010572a:	e8 81 e2 ff ff       	call   801039b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105761:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105768:	e8 43 e2 ff ff       	call   801039b0 <myproc>
...
801057a3:	5d                   	pop    %ebp
  return fork();
801057a4:	e9 67 e4 ff ff       	jmp    80103c10 <fork>
...
801057b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801057b6:	e8 35 e7 ff ff       	call   80103ef0 <exit>
...
801057c3:	5d                   	pop    %ebp
  return wait();
801057c4:	e9 67 e9 ff ff       	jmp    80104130 <wait>
...
801057ee:	e8 9d ea ff ff       	call   80104290 <kill>
...
80105813:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105816:	e8 95 e1 ff ff       	call   801039b0 <myproc>
8010581b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010581e:	c9                   	leave  
8010581f:	c3                   	ret    
...
8010583e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105841:	8b 58 04             	mov    0x4(%eax),%ebx
  if(growproc(n) < 0)
80105844:	ff 75 f4             	pushl  -0xc(%ebp)
80105847:	e8 44 e3 ff ff       	call   80103b90 <growproc>
8010584c:	83 c4 10             	add    $0x10,%esp
8010584f:	85 c0                	test   %eax,%eax
80105851:	78 0d                	js     80105860 <sys_sbrk+0x40>
    return -1;
  return addr;
}
...
80105865:	eb ec                	jmp    80105853 <sys_sbrk+0x33>
...
80105890:	68 60 58 11 80       	push   $0x80115860
...
8010589d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801058a0:	8b 1d a0 60 11 80    	mov    0x801160a0,%ebx
  while(ticks - ticks0 < n){
...
801058b3:	68 60 58 11 80       	push   $0x80115860
801058b8:	68 a0 60 11 80       	push   $0x801160a0
801058bd:	e8 ae e7 ff ff       	call   80104070 <sleep>
  while(ticks - ticks0 < n){
801058c2:	a1 a0 60 11 80       	mov    0x801160a0,%eax
...
801058cf:	73 2f                	jae    80105900 <sys_sleep+0x90>
    if(myproc()->killed){
801058d1:	e8 da e0 ff ff       	call   801039b0 <myproc>
...
801058e0:	68 60 58 11 80       	push   $0x80115860
...
80105903:	68 60 58 11 80       	push   $0x80115860
...
80105924:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105927:	68 60 58 11 80       	push   $0x80115860
8010592c:	e8 2f ed ff ff       	call   80104660 <acquire>
  xticks = ticks;
80105931:	8b 1d a0 60 11 80    	mov    0x801160a0,%ebx
  release(&tickslock);
80105937:	c7 04 24 60 58 11 80 	movl   $0x80115860,(%esp)
...
8010595c:	e8 0f f1 ff ff       	call   80104a70 <argint>
80105961:	83 c4 10             	add    $0x10,%esp
80105964:	85 c0                	test   %eax,%eax
80105966:	78 28                	js     80105990 <sys_setpriority+0x40>
  {
    return -1;
  }
...
80105971:	e8 fa f0 ff ff       	call   80104a70 <argint>
80105976:	83 c4 10             	add    $0x10,%esp
80105979:	85 c0                	test   %eax,%eax
8010597b:	78 13                	js     80105990 <sys_setpriority+0x40>
  {
    return -1;
  }
...
80105980:	ff 75 f4             	pushl  -0xc(%ebp)
80105983:	ff 75 f0             	pushl  -0x10(%ebp)
80105986:	e8 55 e0 ff ff       	call   801039e0 <setpriority>
...
801059d0:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
801059d7:	c7 04 c5 a2 58 11 80 	movl   $0x8e000008,-0x7feea75e(,%eax,8)
801059de:	08 00 00 8e 
801059e2:	66 89 14 c5 a0 58 11 	mov    %dx,-0x7feea760(,%eax,8)
801059e9:	80 
801059ea:	c1 ea 10             	shr    $0x10,%edx
801059ed:	66 89 14 c5 a6 58 11 	mov    %dx,-0x7feea75a(,%eax,8)
801059f4:	80 
  for(i = 0; i < 256; i++)
...
801059ff:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
80105a04:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a07:	c7 05 a2 5a 11 80 08 	movl   $0xef000008,0x80115aa2
80105a0e:	00 00 ef 
  initlock(&tickslock, "time");
80105a11:	68 bd 79 10 80       	push   $0x801079bd
80105a16:	68 60 58 11 80       	push   $0x80115860
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a1b:	66 a3 a0 5a 11 80    	mov    %ax,0x80115aa0
80105a21:	c1 e8 10             	shr    $0x10,%eax
80105a24:	66 a3 a6 5a 11 80    	mov    %ax,0x80115aa6
  initlock(&tickslock, "time");
80105a2a:	e8 f1 ea ff ff       	call   80104520 <initlock>
}
...
80105a4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a4f:	b8 a0 58 11 80       	mov    $0x801158a0,%eax
...
80105a90:	ff 24 85 64 7a 10 80 	jmp    *-0x7fef859c(,%eax,4)
...
80105aed:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105aee:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105af1:	52                   	push   %edx
80105af2:	ff 70 14             	pushl  0x14(%eax)
80105af5:	68 20 7a 10 80       	push   $0x80107a20
...
80105b07:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105b17:	e8 94 de ff ff       	call   801039b0 <myproc>
80105b1c:	8b 50 28             	mov    0x28(%eax),%edx
...
80105b34:	e8 77 de ff ff       	call   801039b0 <myproc>
80105b39:	85 c0                	test   %eax,%eax
80105b3b:	74 0b                	je     80105b48 <trap+0xd8>
80105b3d:	e8 6e de ff ff       	call   801039b0 <myproc>
80105b42:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
80105b46:	74 68                	je     80105bb0 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b48:	e8 63 de ff ff       	call   801039b0 <myproc>
80105b4d:	85 c0                	test   %eax,%eax
80105b4f:	74 19                	je     80105b6a <trap+0xfa>
80105b51:	e8 5a de ff ff       	call   801039b0 <myproc>
80105b56:	8b 40 28             	mov    0x28(%eax),%eax
...
80105b7d:	8b 58 28             	mov    0x28(%eax),%ebx
80105b80:	85 db                	test   %ebx,%ebx
80105b82:	0f 85 e8 00 00 00    	jne    80105c70 <trap+0x200>
    myproc()->tf = tf;
80105b88:	e8 23 de ff ff       	call   801039b0 <myproc>
80105b8d:	89 78 1c             	mov    %edi,0x1c(%eax)
    syscall();
80105b90:	e8 cb ef ff ff       	call   80104b60 <syscall>
    if(myproc()->killed)
80105b95:	e8 16 de ff ff       	call   801039b0 <myproc>
80105b9a:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105bcd:	e8 7e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bd2:	e8 d9 dd ff ff       	call   801039b0 <myproc>
...
80105be4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105be8:	e8 23 ca ff ff       	call   80102610 <kbdintr>
    lapiceoi();
80105bed:	e8 5e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bf2:	e8 b9 dd ff ff       	call   801039b0 <myproc>
...
80105c0d:	e8 3e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c12:	e8 99 dd ff ff       	call   801039b0 <myproc>
...
80105c2f:	e8 5c dd ff ff       	call   80103990 <cpuid>
80105c34:	56                   	push   %esi
80105c35:	53                   	push   %ebx
80105c36:	50                   	push   %eax
80105c37:	68 c8 79 10 80       	push   $0x801079c8
80105c3c:	e8 1f aa ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105c41:	e8 0a cb ff ff       	call   80102750 <lapiceoi>
    break;
...
80105c5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105c60:	e8 1b c4 ff ff       	call   80102080 <ideintr>
80105c65:	e9 63 ff ff ff       	jmp    80105bcd <trap+0x15d>
80105c6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c70:	e8 7b e2 ff ff       	call   80103ef0 <exit>
80105c75:	e9 0e ff ff ff       	jmp    80105b88 <trap+0x118>
80105c7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105c80:	e8 6b e2 ff ff       	call   80103ef0 <exit>
80105c85:	e9 aa fe ff ff       	jmp    80105b34 <trap+0xc4>
80105c8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105c90:	83 ec 0c             	sub    $0xc,%esp
80105c93:	68 60 58 11 80       	push   $0x80115860
80105c98:	e8 c3 e9 ff ff       	call   80104660 <acquire>
      wakeup(&ticks);
80105c9d:	c7 04 24 a0 60 11 80 	movl   $0x801160a0,(%esp)
      ticks++;
80105ca4:	83 05 a0 60 11 80 01 	addl   $0x1,0x801160a0
      wakeup(&ticks);
80105cab:	e8 80 e5 ff ff       	call   80104230 <wakeup>
      release(&tickslock);
80105cb0:	c7 04 24 60 58 11 80 	movl   $0x80115860,(%esp)
80105cb7:	e8 64 ea ff ff       	call   80104720 <release>
80105cbc:	83 c4 10             	add    $0x10,%esp
80105cbf:	e9 09 ff ff ff       	jmp    80105bcd <trap+0x15d>
80105cc4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105cc7:	e8 c4 dc ff ff       	call   80103990 <cpuid>
...
80105cd5:	68 ec 79 10 80       	push   $0x801079ec
80105cda:	e8 81 a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105cdf:	83 c4 14             	add    $0x14,%esp
80105ce2:	68 c2 79 10 80       	push   $0x801079c2
...
{
  if(!uart)
80105cf0:	a1 a0 af 10 80       	mov    0x8010afa0,%eax
{
...
80105dc7:	74 5a                	je     80105e23 <uartinit+0xb3>
  uart = 1;
80105dc9:	c7 05 a0 af 10 80 01 	movl   $0x1,0x8010afa0
80105dd0:	00 00 00 
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bb e4 7a 10 80       	mov    $0x80107ae4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105e08:	74 19                	je     80105e23 <uartinit+0xb3>
  if(!uart)
80105e0a:	8b 15 a0 af 10 80    	mov    0x8010afa0,%edx
...
80105e30 <uartputc>:
  if(!uart)
80105e30:	8b 15 a0 af 10 80    	mov    0x8010afa0,%edx
{
...
80105e77:	6a 00                	push   $0x0
  jmp alltraps
80105e79:	e9 19 fb ff ff       	jmp    80105997 <alltraps>
...
80105e80:	6a 01                	push   $0x1
  jmp alltraps
80105e82:	e9 10 fb ff ff       	jmp    80105997 <alltraps>
...
80105e89:	6a 02                	push   $0x2
  jmp alltraps
80105e8b:	e9 07 fb ff ff       	jmp    80105997 <alltraps>
...
80105e92:	6a 03                	push   $0x3
  jmp alltraps
80105e94:	e9 fe fa ff ff       	jmp    80105997 <alltraps>
...
80105e9b:	6a 04                	push   $0x4
  jmp alltraps
80105e9d:	e9 f5 fa ff ff       	jmp    80105997 <alltraps>
...
80105ea4:	6a 05                	push   $0x5
  jmp alltraps
80105ea6:	e9 ec fa ff ff       	jmp    80105997 <alltraps>
...
80105ead:	6a 06                	push   $0x6
  jmp alltraps
80105eaf:	e9 e3 fa ff ff       	jmp    80105997 <alltraps>
...
80105eb6:	6a 07                	push   $0x7
  jmp alltraps
80105eb8:	e9 da fa ff ff       	jmp    80105997 <alltraps>
...
80105ed4:	6a 0b                	push   $0xb
  jmp alltraps
80105ed6:	e9 bc fa ff ff       	jmp    80105997 <alltraps>
...
80105edb:	6a 0c                	push   $0xc
  jmp alltraps
80105edd:	e9 b5 fa ff ff       	jmp    80105997 <alltraps>
...
80105ee2:	6a 0d                	push   $0xd
  jmp alltraps
80105ee4:	e9 ae fa ff ff       	jmp    80105997 <alltraps>
...
80105ee9:	6a 0e                	push   $0xe
  jmp alltraps
80105eeb:	e9 a7 fa ff ff       	jmp    80105997 <alltraps>
...
80105efb:	6a 10                	push   $0x10
  jmp alltraps
80105efd:	e9 95 fa ff ff       	jmp    80105997 <alltraps>
...
80105f14:	6a 13                	push   $0x13
  jmp alltraps
80105f16:	e9 7c fa ff ff       	jmp    80105997 <alltraps>
...
80105f1d:	6a 14                	push   $0x14
  jmp alltraps
80105f1f:	e9 73 fa ff ff       	jmp    80105997 <alltraps>
...
80105f26:	6a 15                	push   $0x15
  jmp alltraps
80105f28:	e9 6a fa ff ff       	jmp    80105997 <alltraps>
...
80105f2f:	6a 16                	push   $0x16
  jmp alltraps
80105f31:	e9 61 fa ff ff       	jmp    80105997 <alltraps>
...
80105f38:	6a 17                	push   $0x17
  jmp alltraps
80105f3a:	e9 58 fa ff ff       	jmp    80105997 <alltraps>
...
80105f41:	6a 18                	push   $0x18
  jmp alltraps
80105f43:	e9 4f fa ff ff       	jmp    80105997 <alltraps>
...
80105f4a:	6a 19                	push   $0x19
  jmp alltraps
80105f4c:	e9 46 fa ff ff       	jmp    80105997 <alltraps>
...
80105f53:	6a 1a                	push   $0x1a
  jmp alltraps
80105f55:	e9 3d fa ff ff       	jmp    80105997 <alltraps>
...
80105f5c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f5e:	e9 34 fa ff ff       	jmp    80105997 <alltraps>
...
80105f65:	6a 1c                	push   $0x1c
  jmp alltraps
80105f67:	e9 2b fa ff ff       	jmp    80105997 <alltraps>
...
80105f6e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f70:	e9 22 fa ff ff       	jmp    80105997 <alltraps>
...
80105f77:	6a 1e                	push   $0x1e
  jmp alltraps
80105f79:	e9 19 fa ff ff       	jmp    80105997 <alltraps>
...
80105f80:	6a 1f                	push   $0x1f
  jmp alltraps
80105f82:	e9 10 fa ff ff       	jmp    80105997 <alltraps>
...
80105f89:	6a 20                	push   $0x20
  jmp alltraps
80105f8b:	e9 07 fa ff ff       	jmp    80105997 <alltraps>
...
80105f92:	6a 21                	push   $0x21
  jmp alltraps
80105f94:	e9 fe f9 ff ff       	jmp    80105997 <alltraps>
...
80105f9b:	6a 22                	push   $0x22
  jmp alltraps
80105f9d:	e9 f5 f9 ff ff       	jmp    80105997 <alltraps>
...
80105fa4:	6a 23                	push   $0x23
  jmp alltraps
80105fa6:	e9 ec f9 ff ff       	jmp    80105997 <alltraps>
...
80105fad:	6a 24                	push   $0x24
  jmp alltraps
80105faf:	e9 e3 f9 ff ff       	jmp    80105997 <alltraps>
...
80105fb6:	6a 25                	push   $0x25
  jmp alltraps
80105fb8:	e9 da f9 ff ff       	jmp    80105997 <alltraps>
...
80105fbf:	6a 26                	push   $0x26
  jmp alltraps
80105fc1:	e9 d1 f9 ff ff       	jmp    80105997 <alltraps>
...
80105fc8:	6a 27                	push   $0x27
  jmp alltraps
80105fca:	e9 c8 f9 ff ff       	jmp    80105997 <alltraps>
...
80105fd1:	6a 28                	push   $0x28
  jmp alltraps
80105fd3:	e9 bf f9 ff ff       	jmp    80105997 <alltraps>
...
80105fda:	6a 29                	push   $0x29
  jmp alltraps
80105fdc:	e9 b6 f9 ff ff       	jmp    80105997 <alltraps>
...
80105fe3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fe5:	e9 ad f9 ff ff       	jmp    80105997 <alltraps>
...
80105fec:	6a 2b                	push   $0x2b
  jmp alltraps
80105fee:	e9 a4 f9 ff ff       	jmp    80105997 <alltraps>
...
80105ff5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ff7:	e9 9b f9 ff ff       	jmp    80105997 <alltraps>
...
80105ffe:	6a 2d                	push   $0x2d
  jmp alltraps
80106000:	e9 92 f9 ff ff       	jmp    80105997 <alltraps>
...
80106007:	6a 2e                	push   $0x2e
  jmp alltraps
80106009:	e9 89 f9 ff ff       	jmp    80105997 <alltraps>
...
80106010:	6a 2f                	push   $0x2f
  jmp alltraps
80106012:	e9 80 f9 ff ff       	jmp    80105997 <alltraps>
...
80106019:	6a 30                	push   $0x30
  jmp alltraps
8010601b:	e9 77 f9 ff ff       	jmp    80105997 <alltraps>
...
80106022:	6a 31                	push   $0x31
  jmp alltraps
80106024:	e9 6e f9 ff ff       	jmp    80105997 <alltraps>
...
8010602b:	6a 32                	push   $0x32
  jmp alltraps
8010602d:	e9 65 f9 ff ff       	jmp    80105997 <alltraps>
...
80106034:	6a 33                	push   $0x33
  jmp alltraps
80106036:	e9 5c f9 ff ff       	jmp    80105997 <alltraps>
...
8010603d:	6a 34                	push   $0x34
  jmp alltraps
8010603f:	e9 53 f9 ff ff       	jmp    80105997 <alltraps>
...
80106046:	6a 35                	push   $0x35
  jmp alltraps
80106048:	e9 4a f9 ff ff       	jmp    80105997 <alltraps>
...
8010604f:	6a 36                	push   $0x36
  jmp alltraps
80106051:	e9 41 f9 ff ff       	jmp    80105997 <alltraps>
...
80106058:	6a 37                	push   $0x37
  jmp alltraps
8010605a:	e9 38 f9 ff ff       	jmp    80105997 <alltraps>
...
80106061:	6a 38                	push   $0x38
  jmp alltraps
80106063:	e9 2f f9 ff ff       	jmp    80105997 <alltraps>
...
8010606a:	6a 39                	push   $0x39
  jmp alltraps
8010606c:	e9 26 f9 ff ff       	jmp    80105997 <alltraps>
...
80106073:	6a 3a                	push   $0x3a
  jmp alltraps
80106075:	e9 1d f9 ff ff       	jmp    80105997 <alltraps>
...
8010607c:	6a 3b                	push   $0x3b
  jmp alltraps
8010607e:	e9 14 f9 ff ff       	jmp    80105997 <alltraps>
...
80106085:	6a 3c                	push   $0x3c
  jmp alltraps
80106087:	e9 0b f9 ff ff       	jmp    80105997 <alltraps>
...
8010608e:	6a 3d                	push   $0x3d
  jmp alltraps
80106090:	e9 02 f9 ff ff       	jmp    80105997 <alltraps>
...
80106097:	6a 3e                	push   $0x3e
  jmp alltraps
80106099:	e9 f9 f8 ff ff       	jmp    80105997 <alltraps>
...
801060a0:	6a 3f                	push   $0x3f
  jmp alltraps
801060a2:	e9 f0 f8 ff ff       	jmp    80105997 <alltraps>
...
801060a9:	6a 40                	push   $0x40
  jmp alltraps
801060ab:	e9 e7 f8 ff ff       	jmp    80105997 <alltraps>
...
801060b2:	6a 41                	push   $0x41
  jmp alltraps
801060b4:	e9 de f8 ff ff       	jmp    80105997 <alltraps>
...
801060bb:	6a 42                	push   $0x42
  jmp alltraps
801060bd:	e9 d5 f8 ff ff       	jmp    80105997 <alltraps>
...
801060c4:	6a 43                	push   $0x43
  jmp alltraps
801060c6:	e9 cc f8 ff ff       	jmp    80105997 <alltraps>
...
801060cd:	6a 44                	push   $0x44
  jmp alltraps
801060cf:	e9 c3 f8 ff ff       	jmp    80105997 <alltraps>
...
801060d6:	6a 45                	push   $0x45
  jmp alltraps
801060d8:	e9 ba f8 ff ff       	jmp    80105997 <alltraps>
...
801060df:	6a 46                	push   $0x46
  jmp alltraps
801060e1:	e9 b1 f8 ff ff       	jmp    80105997 <alltraps>
...
801060e8:	6a 47                	push   $0x47
  jmp alltraps
801060ea:	e9 a8 f8 ff ff       	jmp    80105997 <alltraps>
...
801060f1:	6a 48                	push   $0x48
  jmp alltraps
801060f3:	e9 9f f8 ff ff       	jmp    80105997 <alltraps>
...
801060fa:	6a 49                	push   $0x49
  jmp alltraps
801060fc:	e9 96 f8 ff ff       	jmp    80105997 <alltraps>
...
80106103:	6a 4a                	push   $0x4a
  jmp alltraps
80106105:	e9 8d f8 ff ff       	jmp    80105997 <alltraps>
...
8010610c:	6a 4b                	push   $0x4b
  jmp alltraps
8010610e:	e9 84 f8 ff ff       	jmp    80105997 <alltraps>
...
80106115:	6a 4c                	push   $0x4c
  jmp alltraps
80106117:	e9 7b f8 ff ff       	jmp    80105997 <alltraps>
...
8010611e:	6a 4d                	push   $0x4d
  jmp alltraps
80106120:	e9 72 f8 ff ff       	jmp    80105997 <alltraps>
...
80106127:	6a 4e                	push   $0x4e
  jmp alltraps
80106129:	e9 69 f8 ff ff       	jmp    80105997 <alltraps>
...
80106130:	6a 4f                	push   $0x4f
  jmp alltraps
80106132:	e9 60 f8 ff ff       	jmp    80105997 <alltraps>
...
80106139:	6a 50                	push   $0x50
  jmp alltraps
8010613b:	e9 57 f8 ff ff       	jmp    80105997 <alltraps>
...
80106142:	6a 51                	push   $0x51
  jmp alltraps
80106144:	e9 4e f8 ff ff       	jmp    80105997 <alltraps>
...
8010614b:	6a 52                	push   $0x52
  jmp alltraps
8010614d:	e9 45 f8 ff ff       	jmp    80105997 <alltraps>
...
80106154:	6a 53                	push   $0x53
  jmp alltraps
80106156:	e9 3c f8 ff ff       	jmp    80105997 <alltraps>
...
8010615d:	6a 54                	push   $0x54
  jmp alltraps
8010615f:	e9 33 f8 ff ff       	jmp    80105997 <alltraps>
...
80106166:	6a 55                	push   $0x55
  jmp alltraps
80106168:	e9 2a f8 ff ff       	jmp    80105997 <alltraps>
...
8010616f:	6a 56                	push   $0x56
  jmp alltraps
80106171:	e9 21 f8 ff ff       	jmp    80105997 <alltraps>
...
80106178:	6a 57                	push   $0x57
  jmp alltraps
8010617a:	e9 18 f8 ff ff       	jmp    80105997 <alltraps>
...
80106181:	6a 58                	push   $0x58
  jmp alltraps
80106183:	e9 0f f8 ff ff       	jmp    80105997 <alltraps>
...
8010618a:	6a 59                	push   $0x59
  jmp alltraps
8010618c:	e9 06 f8 ff ff       	jmp    80105997 <alltraps>
...
80106193:	6a 5a                	push   $0x5a
  jmp alltraps
80106195:	e9 fd f7 ff ff       	jmp    80105997 <alltraps>
...
8010619c:	6a 5b                	push   $0x5b
  jmp alltraps
8010619e:	e9 f4 f7 ff ff       	jmp    80105997 <alltraps>
...
801061a5:	6a 5c                	push   $0x5c
  jmp alltraps
801061a7:	e9 eb f7 ff ff       	jmp    80105997 <alltraps>
...
801061ae:	6a 5d                	push   $0x5d
  jmp alltraps
801061b0:	e9 e2 f7 ff ff       	jmp    80105997 <alltraps>
...
801061b7:	6a 5e                	push   $0x5e
  jmp alltraps
801061b9:	e9 d9 f7 ff ff       	jmp    80105997 <alltraps>
...
801061c0:	6a 5f                	push   $0x5f
  jmp alltraps
801061c2:	e9 d0 f7 ff ff       	jmp    80105997 <alltraps>
...
801061c9:	6a 60                	push   $0x60
  jmp alltraps
801061cb:	e9 c7 f7 ff ff       	jmp    80105997 <alltraps>
...
801061d2:	6a 61                	push   $0x61
  jmp alltraps
801061d4:	e9 be f7 ff ff       	jmp    80105997 <alltraps>
...
801061db:	6a 62                	push   $0x62
  jmp alltraps
801061dd:	e9 b5 f7 ff ff       	jmp    80105997 <alltraps>
...
801061e4:	6a 63                	push   $0x63
  jmp alltraps
801061e6:	e9 ac f7 ff ff       	jmp    80105997 <alltraps>
...
801061ed:	6a 64                	push   $0x64
  jmp alltraps
801061ef:	e9 a3 f7 ff ff       	jmp    80105997 <alltraps>
...
801061f6:	6a 65                	push   $0x65
  jmp alltraps
801061f8:	e9 9a f7 ff ff       	jmp    80105997 <alltraps>
...
801061ff:	6a 66                	push   $0x66
  jmp alltraps
80106201:	e9 91 f7 ff ff       	jmp    80105997 <alltraps>
...
80106208:	6a 67                	push   $0x67
  jmp alltraps
8010620a:	e9 88 f7 ff ff       	jmp    80105997 <alltraps>
...
80106211:	6a 68                	push   $0x68
  jmp alltraps
80106213:	e9 7f f7 ff ff       	jmp    80105997 <alltraps>
...
8010621a:	6a 69                	push   $0x69
  jmp alltraps
8010621c:	e9 76 f7 ff ff       	jmp    80105997 <alltraps>
...
80106223:	6a 6a                	push   $0x6a
  jmp alltraps
80106225:	e9 6d f7 ff ff       	jmp    80105997 <alltraps>
...
8010622c:	6a 6b                	push   $0x6b
  jmp alltraps
8010622e:	e9 64 f7 ff ff       	jmp    80105997 <alltraps>
...
80106235:	6a 6c                	push   $0x6c
  jmp alltraps
80106237:	e9 5b f7 ff ff       	jmp    80105997 <alltraps>
...
8010623e:	6a 6d                	push   $0x6d
  jmp alltraps
80106240:	e9 52 f7 ff ff       	jmp    80105997 <alltraps>
...
80106247:	6a 6e                	push   $0x6e
  jmp alltraps
80106249:	e9 49 f7 ff ff       	jmp    80105997 <alltraps>
...
80106250:	6a 6f                	push   $0x6f
  jmp alltraps
80106252:	e9 40 f7 ff ff       	jmp    80105997 <alltraps>
...
80106259:	6a 70                	push   $0x70
  jmp alltraps
8010625b:	e9 37 f7 ff ff       	jmp    80105997 <alltraps>
...
80106262:	6a 71                	push   $0x71
  jmp alltraps
80106264:	e9 2e f7 ff ff       	jmp    80105997 <alltraps>
...
8010626b:	6a 72                	push   $0x72
  jmp alltraps
8010626d:	e9 25 f7 ff ff       	jmp    80105997 <alltraps>
...
80106274:	6a 73                	push   $0x73
  jmp alltraps
80106276:	e9 1c f7 ff ff       	jmp    80105997 <alltraps>
...
8010627d:	6a 74                	push   $0x74
  jmp alltraps
8010627f:	e9 13 f7 ff ff       	jmp    80105997 <alltraps>
...
80106286:	6a 75                	push   $0x75
  jmp alltraps
80106288:	e9 0a f7 ff ff       	jmp    80105997 <alltraps>
...
8010628f:	6a 76                	push   $0x76
  jmp alltraps
80106291:	e9 01 f7 ff ff       	jmp    80105997 <alltraps>
...
80106298:	6a 77                	push   $0x77
  jmp alltraps
8010629a:	e9 f8 f6 ff ff       	jmp    80105997 <alltraps>
...
801062a1:	6a 78                	push   $0x78
  jmp alltraps
801062a3:	e9 ef f6 ff ff       	jmp    80105997 <alltraps>
...
801062aa:	6a 79                	push   $0x79
  jmp alltraps
801062ac:	e9 e6 f6 ff ff       	jmp    80105997 <alltraps>
...
801062b3:	6a 7a                	push   $0x7a
  jmp alltraps
801062b5:	e9 dd f6 ff ff       	jmp    80105997 <alltraps>
...
801062bc:	6a 7b                	push   $0x7b
  jmp alltraps
801062be:	e9 d4 f6 ff ff       	jmp    80105997 <alltraps>
...
801062c5:	6a 7c                	push   $0x7c
  jmp alltraps
801062c7:	e9 cb f6 ff ff       	jmp    80105997 <alltraps>
...
801062ce:	6a 7d                	push   $0x7d
  jmp alltraps
801062d0:	e9 c2 f6 ff ff       	jmp    80105997 <alltraps>
...
801062d7:	6a 7e                	push   $0x7e
  jmp alltraps
801062d9:	e9 b9 f6 ff ff       	jmp    80105997 <alltraps>
...
801062e0:	6a 7f                	push   $0x7f
  jmp alltraps
801062e2:	e9 b0 f6 ff ff       	jmp    80105997 <alltraps>
...
801062e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062ee:	e9 a4 f6 ff ff       	jmp    80105997 <alltraps>
...
801062f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062fa:	e9 98 f6 ff ff       	jmp    80105997 <alltraps>
...
80106301:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106306:	e9 8c f6 ff ff       	jmp    80105997 <alltraps>
...
8010630d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106312:	e9 80 f6 ff ff       	jmp    80105997 <alltraps>
...
80106319:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010631e:	e9 74 f6 ff ff       	jmp    80105997 <alltraps>
...
80106325:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010632a:	e9 68 f6 ff ff       	jmp    80105997 <alltraps>
...
80106331:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106336:	e9 5c f6 ff ff       	jmp    80105997 <alltraps>
...
8010633d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106342:	e9 50 f6 ff ff       	jmp    80105997 <alltraps>
...
80106349:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010634e:	e9 44 f6 ff ff       	jmp    80105997 <alltraps>
...
80106355:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010635a:	e9 38 f6 ff ff       	jmp    80105997 <alltraps>
...
80106361:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106366:	e9 2c f6 ff ff       	jmp    80105997 <alltraps>
...
8010636d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106372:	e9 20 f6 ff ff       	jmp    80105997 <alltraps>
...
80106379:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010637e:	e9 14 f6 ff ff       	jmp    80105997 <alltraps>
...
80106385:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010638a:	e9 08 f6 ff ff       	jmp    80105997 <alltraps>
...
80106391:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106396:	e9 fc f5 ff ff       	jmp    80105997 <alltraps>
...
8010639d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063a2:	e9 f0 f5 ff ff       	jmp    80105997 <alltraps>
...
801063a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063ae:	e9 e4 f5 ff ff       	jmp    80105997 <alltraps>
...
801063b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063ba:	e9 d8 f5 ff ff       	jmp    80105997 <alltraps>
...
801063c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063c6:	e9 cc f5 ff ff       	jmp    80105997 <alltraps>
...
801063cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063d2:	e9 c0 f5 ff ff       	jmp    80105997 <alltraps>
...
801063d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063de:	e9 b4 f5 ff ff       	jmp    80105997 <alltraps>
...
801063e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063ea:	e9 a8 f5 ff ff       	jmp    80105997 <alltraps>
...
801063f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801063f6:	e9 9c f5 ff ff       	jmp    80105997 <alltraps>
...
801063fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106402:	e9 90 f5 ff ff       	jmp    80105997 <alltraps>
...
80106409:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010640e:	e9 84 f5 ff ff       	jmp    80105997 <alltraps>
...
80106415:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010641a:	e9 78 f5 ff ff       	jmp    80105997 <alltraps>
...
80106421:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106426:	e9 6c f5 ff ff       	jmp    80105997 <alltraps>
...
8010642d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106432:	e9 60 f5 ff ff       	jmp    80105997 <alltraps>
...
80106439:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010643e:	e9 54 f5 ff ff       	jmp    80105997 <alltraps>
...
80106445:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010644a:	e9 48 f5 ff ff       	jmp    80105997 <alltraps>
...
80106451:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106456:	e9 3c f5 ff ff       	jmp    80105997 <alltraps>
...
8010645d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106462:	e9 30 f5 ff ff       	jmp    80105997 <alltraps>
...
80106469:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010646e:	e9 24 f5 ff ff       	jmp    80105997 <alltraps>
...
80106475:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010647a:	e9 18 f5 ff ff       	jmp    80105997 <alltraps>
...
80106481:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106486:	e9 0c f5 ff ff       	jmp    80105997 <alltraps>
...
8010648d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106492:	e9 00 f5 ff ff       	jmp    80105997 <alltraps>
...
80106499:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010649e:	e9 f4 f4 ff ff       	jmp    80105997 <alltraps>
...
801064a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064aa:	e9 e8 f4 ff ff       	jmp    80105997 <alltraps>
...
801064b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064b6:	e9 dc f4 ff ff       	jmp    80105997 <alltraps>
...
801064bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064c2:	e9 d0 f4 ff ff       	jmp    80105997 <alltraps>
...
801064c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064ce:	e9 c4 f4 ff ff       	jmp    80105997 <alltraps>
...
801064d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064da:	e9 b8 f4 ff ff       	jmp    80105997 <alltraps>
...
801064e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064e6:	e9 ac f4 ff ff       	jmp    80105997 <alltraps>
...
801064ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801064f2:	e9 a0 f4 ff ff       	jmp    80105997 <alltraps>
...
801064f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801064fe:	e9 94 f4 ff ff       	jmp    80105997 <alltraps>
...
80106505:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010650a:	e9 88 f4 ff ff       	jmp    80105997 <alltraps>
...
80106511:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106516:	e9 7c f4 ff ff       	jmp    80105997 <alltraps>
...
8010651d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106522:	e9 70 f4 ff ff       	jmp    80105997 <alltraps>
...
80106529:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010652e:	e9 64 f4 ff ff       	jmp    80105997 <alltraps>
...
80106535:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010653a:	e9 58 f4 ff ff       	jmp    80105997 <alltraps>
...
80106541:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106546:	e9 4c f4 ff ff       	jmp    80105997 <alltraps>
...
8010654d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106552:	e9 40 f4 ff ff       	jmp    80105997 <alltraps>
...
80106559:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010655e:	e9 34 f4 ff ff       	jmp    80105997 <alltraps>
...
80106565:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010656a:	e9 28 f4 ff ff       	jmp    80105997 <alltraps>
...
80106571:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106576:	e9 1c f4 ff ff       	jmp    80105997 <alltraps>
...
8010657d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106582:	e9 10 f4 ff ff       	jmp    80105997 <alltraps>
...
80106589:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010658e:	e9 04 f4 ff ff       	jmp    80105997 <alltraps>
...
80106595:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010659a:	e9 f8 f3 ff ff       	jmp    80105997 <alltraps>
...
801065a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065a6:	e9 ec f3 ff ff       	jmp    80105997 <alltraps>
...
801065ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065b2:	e9 e0 f3 ff ff       	jmp    80105997 <alltraps>
...
801065b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065be:	e9 d4 f3 ff ff       	jmp    80105997 <alltraps>
...
801065c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065ca:	e9 c8 f3 ff ff       	jmp    80105997 <alltraps>
...
801065d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065d6:	e9 bc f3 ff ff       	jmp    80105997 <alltraps>
...
801065dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065e2:	e9 b0 f3 ff ff       	jmp    80105997 <alltraps>
...
801065e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801065ee:	e9 a4 f3 ff ff       	jmp    80105997 <alltraps>
...
801065f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801065fa:	e9 98 f3 ff ff       	jmp    80105997 <alltraps>
...
80106601:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106606:	e9 8c f3 ff ff       	jmp    80105997 <alltraps>
...
8010660d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106612:	e9 80 f3 ff ff       	jmp    80105997 <alltraps>
...
80106619:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010661e:	e9 74 f3 ff ff       	jmp    80105997 <alltraps>
...
80106625:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010662a:	e9 68 f3 ff ff       	jmp    80105997 <alltraps>
...
80106631:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106636:	e9 5c f3 ff ff       	jmp    80105997 <alltraps>
...
8010663d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106642:	e9 50 f3 ff ff       	jmp    80105997 <alltraps>
...
80106649:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010664e:	e9 44 f3 ff ff       	jmp    80105997 <alltraps>
...
80106655:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010665a:	e9 38 f3 ff ff       	jmp    80105997 <alltraps>
...
80106661:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106666:	e9 2c f3 ff ff       	jmp    80105997 <alltraps>
...
8010666d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106672:	e9 20 f3 ff ff       	jmp    80105997 <alltraps>
...
80106679:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010667e:	e9 14 f3 ff ff       	jmp    80105997 <alltraps>
...
80106685:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010668a:	e9 08 f3 ff ff       	jmp    80105997 <alltraps>
...
80106691:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106696:	e9 fc f2 ff ff       	jmp    80105997 <alltraps>
...
8010669d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066a2:	e9 f0 f2 ff ff       	jmp    80105997 <alltraps>
...
801066a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066ae:	e9 e4 f2 ff ff       	jmp    80105997 <alltraps>
...
801066b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066ba:	e9 d8 f2 ff ff       	jmp    80105997 <alltraps>
...
801066c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066c6:	e9 cc f2 ff ff       	jmp    80105997 <alltraps>
...
801066cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066d2:	e9 c0 f2 ff ff       	jmp    80105997 <alltraps>
...
801066d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066de:	e9 b4 f2 ff ff       	jmp    80105997 <alltraps>
...
801066e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066ea:	e9 a8 f2 ff ff       	jmp    80105997 <alltraps>
...
801066f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801066f6:	e9 9c f2 ff ff       	jmp    80105997 <alltraps>
...
801066fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106702:	e9 90 f2 ff ff       	jmp    80105997 <alltraps>
...
80106709:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010670e:	e9 84 f2 ff ff       	jmp    80105997 <alltraps>
...
80106715:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010671a:	e9 78 f2 ff ff       	jmp    80105997 <alltraps>
...
80106721:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106726:	e9 6c f2 ff ff       	jmp    80105997 <alltraps>
...
8010672d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106732:	e9 60 f2 ff ff       	jmp    80105997 <alltraps>
...
80106739:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010673e:	e9 54 f2 ff ff       	jmp    80105997 <alltraps>
...
80106745:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010674a:	e9 48 f2 ff ff       	jmp    80105997 <alltraps>
...
80106751:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106756:	e9 3c f2 ff ff       	jmp    80105997 <alltraps>
...
8010675d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106762:	e9 30 f2 ff ff       	jmp    80105997 <alltraps>
...
80106769:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010676e:	e9 24 f2 ff ff       	jmp    80105997 <alltraps>
...
80106775:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010677a:	e9 18 f2 ff ff       	jmp    80105997 <alltraps>
...
80106781:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106786:	e9 0c f2 ff ff       	jmp    80105997 <alltraps>
...
8010678d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106792:	e9 00 f2 ff ff       	jmp    80105997 <alltraps>
...
80106799:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010679e:	e9 f4 f1 ff ff       	jmp    80105997 <alltraps>
...
801067a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067aa:	e9 e8 f1 ff ff       	jmp    80105997 <alltraps>
...
801067b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067b6:	e9 dc f1 ff ff       	jmp    80105997 <alltraps>
...
801067bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067c2:	e9 d0 f1 ff ff       	jmp    80105997 <alltraps>
...
801067c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067ce:	e9 c4 f1 ff ff       	jmp    80105997 <alltraps>
...
801067d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067da:	e9 b8 f1 ff ff       	jmp    80105997 <alltraps>
...
801067e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067e6:	e9 ac f1 ff ff       	jmp    80105997 <alltraps>
...
801067ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801067f2:	e9 a0 f1 ff ff       	jmp    80105997 <alltraps>
...
801067f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801067fe:	e9 94 f1 ff ff       	jmp    80105997 <alltraps>
...
80106805:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010680a:	e9 88 f1 ff ff       	jmp    80105997 <alltraps>
...
80106811:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106816:	e9 7c f1 ff ff       	jmp    80105997 <alltraps>
...
8010681d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106822:	e9 70 f1 ff ff       	jmp    80105997 <alltraps>
...
80106829:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010682e:	e9 64 f1 ff ff       	jmp    80105997 <alltraps>
...
80106835:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010683a:	e9 58 f1 ff ff       	jmp    80105997 <alltraps>
...
80106841:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106846:	e9 4c f1 ff ff       	jmp    80105997 <alltraps>
...
8010684d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106852:	e9 40 f1 ff ff       	jmp    80105997 <alltraps>
...
80106859:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010685e:	e9 34 f1 ff ff       	jmp    80105997 <alltraps>
...
80106865:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010686a:	e9 28 f1 ff ff       	jmp    80105997 <alltraps>
...
80106871:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106876:	e9 1c f1 ff ff       	jmp    80105997 <alltraps>
...
8010687d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106882:	e9 10 f1 ff ff       	jmp    80105997 <alltraps>
...
80106889:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010688e:	e9 04 f1 ff ff       	jmp    80105997 <alltraps>
...
80106895:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010689a:	e9 f8 f0 ff ff       	jmp    80105997 <alltraps>
...
801068a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068a6:	e9 ec f0 ff ff       	jmp    80105997 <alltraps>
...
801068ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068b2:	e9 e0 f0 ff ff       	jmp    80105997 <alltraps>
...
801068b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068be:	e9 d4 f0 ff ff       	jmp    80105997 <alltraps>
...
801068c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068ca:	e9 c8 f0 ff ff       	jmp    80105997 <alltraps>
...
801068d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068d6:	e9 bc f0 ff ff       	jmp    80105997 <alltraps>
...
801068dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068e2:	e9 b0 f0 ff ff       	jmp    80105997 <alltraps>
...
8010694a:	e8 21 de ff ff       	call   80104770 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069ed:	68 ec 7a 10 80       	push   $0x80107aec
...
80106aa3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106aa6:	e8 e5 ce ff ff       	call   80103990 <cpuid>
...
80106aba:	c7 80 f8 31 11 80 ff 	movl   $0xffff,-0x7feece08(%eax)
80106ac1:	ff 00 00 
80106ac4:	c7 80 fc 31 11 80 00 	movl   $0xcf9a00,-0x7feece04(%eax)
80106acb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ace:	c7 80 00 32 11 80 ff 	movl   $0xffff,-0x7feece00(%eax)
80106ad5:	ff 00 00 
80106ad8:	c7 80 04 32 11 80 00 	movl   $0xcf9200,-0x7feecdfc(%eax)
80106adf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106ae2:	c7 80 08 32 11 80 ff 	movl   $0xffff,-0x7feecdf8(%eax)
80106ae9:	ff 00 00 
80106aec:	c7 80 0c 32 11 80 00 	movl   $0xcffa00,-0x7feecdf4(%eax)
80106af3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106af6:	c7 80 10 32 11 80 ff 	movl   $0xffff,-0x7feecdf0(%eax)
80106afd:	ff 00 00 
80106b00:	c7 80 14 32 11 80 00 	movl   $0xcff200,-0x7feecdec(%eax)
80106b07:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b0a:	05 f0 31 11 80       	add    $0x801131f0,%eax
  pd[1] = (uint)p;
...
80106b30:	a1 a4 60 11 80       	mov    0x801160a4,%eax
{
...
80106b5e:	0f 84 cb 00 00 00    	je     80106c2f <switchuvm+0xdf>
  if(p->kstack == 0)
80106b64:	8b 43 0c             	mov    0xc(%ebx),%eax
80106b67:	85 c0                	test   %eax,%eax
80106b69:	0f 84 da 00 00 00    	je     80106c49 <switchuvm+0xf9>
  if(p->pgdir == 0)
80106b6f:	8b 43 08             	mov    0x8(%ebx),%eax
80106b72:	85 c0                	test   %eax,%eax
80106b74:	0f 84 c2 00 00 00    	je     80106c3c <switchuvm+0xec>
  pushcli();
80106b7a:	e8 11 da ff ff       	call   80104590 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b7f:	e8 8c cd ff ff       	call   80103910 <mycpu>
80106b84:	89 c6                	mov    %eax,%esi
80106b86:	e8 85 cd ff ff       	call   80103910 <mycpu>
80106b8b:	89 c7                	mov    %eax,%edi
80106b8d:	e8 7e cd ff ff       	call   80103910 <mycpu>
80106b92:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b95:	83 c7 08             	add    $0x8,%edi
80106b98:	e8 73 cd ff ff       	call   80103910 <mycpu>
...
80106c8f:	e8 dc da ff ff       	call   80104770 <memset>
...
80106cc0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cc1:	e9 5a db ff ff       	jmp    80104820 <memmove>
    panic("inituvm: more than a page");
80106cc6:	83 ec 0c             	sub    $0xc,%esp
80106cc9:	68 31 7b 10 80       	push   $0x80107b31
...
80106deb:	e8 80 d9 ff ff       	call   80104770 <memset>
...
80106e2d:	68 69 7b 10 80       	push   $0x80107b69
...
80106e63:	68 81 7b 10 80       	push   $0x80107b81
...
80106f6c:	68 9d 7b 10 80       	push   $0x80107b9d
...
80106fa0:	e8 cb d7 ff ff       	call   80104770 <memset>
...
8010700b:	a3 a4 60 11 80       	mov    %eax,0x801160a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010703f:	68 ae 7b 10 80       	push   $0x80107bae
...
80107090:	e8 8b d7 ff ff       	call   80104820 <memmove>
...
80107129:	68 d2 7b 10 80       	push   $0x80107bd2
8010712e:	e8 5d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107133:	83 ec 0c             	sub    $0xc,%esp
80107136:	68 b8 7b 10 80       	push   $0x80107bb8
...
801071bf:	e8 5c d6 ff ff       	call   80104820 <memmove>
    len -= n;
    buf += n;
